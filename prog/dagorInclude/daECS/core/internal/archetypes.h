...
#pragma pack(pop)
  ...
  uint64_t getBloomBitmask(uint32_t archetype) const { return archetypes.get<BLOOM_BITMASK>()[archetype]; }
  ...
  eastl::tuple_vector<Archetype, uint32_t, ArchetypeInfo, eastl::underlying_type_t<ComponentTypeFlags>, SmallTab<TrackedPod>, uint32_t,
    ...
    SmallTab<CreatableComponent>, SmallTab<ResourceComponent>,
    uint64_t>   // bloom filter bitmask
