...
typedef bool (*apple_continue_user_activity_callback)(UIApplication *application, NSUserActivity *userActivity);

namespace apple
{
void setOnDidFinishLaunchingWithOptionsFunc(apple_events_callback_with_dictionary func);
void setOnContinueUserActivityFunc(apple_continue_user_activity_callback func);
