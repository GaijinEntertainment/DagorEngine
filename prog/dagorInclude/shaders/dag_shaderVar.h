...
size_t get_subinterval_count(Interval interv);
...
bool set_float(int variable_id, float v);
bool set_float4(int variable_id, const Point2 &rg, const Point2 &ba = Point2(0, 0));
bool set_float4(int variable_id, const Point3 &rgb, float a = 0.f);
bool set_float4(int variable_id, const Point4 &v);
bool set_float4(int variable_id, const Color4 &v);
bool set_float4(int variable_id, const Color3 &rgb, float a = 0.f);
bool set_float4(int variable_id, float r, float g, float b = 0.f, float a = 0.f);
bool set_float4_array(int variable_id, const Color4 *data, int count);
bool set_float4_array(int variable_id, const Point4 *data, int count);
bool set_float4(int variable_id, E3DCOLOR c);
bool set_float4(int variable_id, const XMFLOAT2 &rg, const XMFLOAT2 &ba);
bool set_float4(int variable_id, const XMFLOAT3 &rgb, float a = 0.f);
bool set_float4(int variable_id, const XMFLOAT4 &v);
bool set_float4(int variable_id, FXMVECTOR v);
...
/// @note If using this, always call set_buffer_unsafe(id, nullptr) or set_buffer(id, BAD_TEXTUREID) after manually
bool set_buffer_unsafe(int variable_id, Sbuffer *buffer_ptr);
...
/// @brief Reload references to resource for all related global shader vars.
// it's temporary method that will be removed after all leaks of frame graph resources will be fixed
void sync_managed_resource(TEXTUREID id, D3dResource *old_res_ptr);
...
float get_float(int glob_var_id);
Color4 get_float4(int glob_var_id);
TEXTUREID get_tex_fast(int glob_var_id);
BaseTexture *get_tex_ptr_fast(int glob_var_id);
D3DRESID get_buf_fast(int glob_var_id);
Sbuffer *get_buf_ptr_fast(int glob_var_id);
...
inline Sbuffer *get_buf_ptr(int glob_var_id) { return get_buf_ptr_fast(glob_var_id); }
