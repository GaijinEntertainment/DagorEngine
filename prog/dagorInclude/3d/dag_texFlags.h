...
enum
{
  ...
  TEXFMT_R11G11B10F = 0x1E000000U,     // float
  TEXFMT_R9G9B9E5 = 0x1F000000U,
  TEXFMT_R8G8 = 0x20000000U,  // unorm, dx10+, OGL+
  TEXFMT_R8G8S = 0x21000000U, // snorm, dx10+, OGL+
  TEXFMT_BC6H = 0x22000000U,
  TEXFMT_BC7 = 0x23000000U,
  TEXFMT_R8UI = 0x24000000U,

  // should go in a row
  TEXFMT_DEPTH24 = 0x25000000U,
  TEXFMT_DEPTH16 = 0x26000000U,
  TEXFMT_DEPTH32 = 0x27000000U,
  TEXFMT_DEPTH32_S8 = 0x28000000U,

  // mobile formats:
  TEXFMT_PVRTC2X = 0x29000000U,
  TEXFMT_PVRTC2A = 0x2A000000U,
  TEXFMT_PVRTC4X = 0x2B000000U,
  TEXFMT_PVRTC4A = 0x2C000000U,

  TEXFMT_ASTC4 = 0x2D000000U,
  TEXFMT_ASTC8 = 0x2E000000U,
  TEXFMT_ASTC12 = 0x2F000000U,

  TEXFMT_ETC2_RG = 0x30000000U,
  TEXFMT_ETC2_RGBA = 0x31000000U,
