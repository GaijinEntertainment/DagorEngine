...
public:
  ...
  ReflectionVarScalar() : ReflectionVarBase<T, EventListener>() {} //-V730

  explicit ReflectionVarScalar(const T &other) : ReflectionVarBase<T, EventListener>(other) {} //-V730
...
inline bool is_const_ptr(const void *) { return true; } //-V659
...
DECL_VEC_CLASS(Point3, float x; float y; float z;, )     //-V730
DECL_VEC_CLASS(DPoint3, double x; double y; double z;, ) //-V730
DECL_VEC_CLASS(IPoint3, int x; int y; int z;, )          //-V730

DECL_VEC_CLASS(Point4, float x; float y; float z; float w;, ) //-V730
DECL_VEC_CLASS(IPoint4, int x; int y; int z; int w;, )        //-V730
