...
EditableObject *EntityObjEditor::cloneObject(EditableObject *, bool)
{
  G_ASSERT(0);
  return nullptr;
}
...
EditableObject *EntityObjEditor::getObjectByEid(ecs::EntityId) const
{
  G_ASSERT(0);
  return nullptr;
}
ecs::EntityId EntityObjEditor::createEntityDirect(EntCreateData *)
{
  G_ASSERT(0);
