...
#define RIEXTRA_PER_INSTANCE_RENDER_DATA_FLAG_BIT_COUNT 5
...
#define RIEXTRA_PER_INSTANCE_RENDER_DATA__TREE_BURNING__FLAG (1<<4)
...
#define RIEXTRA_PER_INSTANCE_RENDER_DATA__TREE_BURNING__SIZE (1)
...
#define RIEXTRA_PER_INSTANCE_RENDER_DATA__TREE_BURNING__OFFSET(flags) \
  ((((flags)&RIEXTRA_PER_INSTANCE_RENDER_DATA__INITIAL_TM_POS__FLAG) ? RIEXTRA_PER_INSTANCE_RENDER_DATA__INITIAL_TM_POS__SIZE : 0) + \
  (((flags)&RIEXTRA_PER_INSTANCE_RENDER_DATA__INITIAL_TM_3X3__FLAG) ? RIEXTRA_PER_INSTANCE_RENDER_DATA__INITIAL_TM_3X3__SIZE : 0) + \
  (((flags)&RIEXTRA_PER_INSTANCE_RENDER_DATA__PREV_TRANSFORM__FLAG) ? RIEXTRA_PER_INSTANCE_RENDER_DATA__PREV_TRANSFORM__SIZE : 0) + \
  (((flags)&RIEXTRA_PER_INSTANCE_RENDER_DATA__DESTR_RENDER_DATA__FLAG) ? RIEXTRA_PER_INSTANCE_RENDER_DATA__DESTR_RENDER_DATA__SIZE : 0))
