...
namespace dynmodel_additional_data
{
...
public:
  ...
  static const AnimcharAdditionalDataView &get_null() { return NULL_METADATA; }
...
// return index in additional_data for this DataType, this function invalidates results of previous request_space calls
template <int type, typename PointList>
int request_space(PointList &data, int size)
{
  G_STATIC_ASSERT(type >= 0 && type < 8);
  if (data.size() < 2)
  {
...
inline const Point4 AnimcharAdditionalDataView::NULL_METADATA_RAW[] = {Point4::ZERO, Point4::ZERO};
inline const AnimcharAdditionalDataView AnimcharAdditionalDataView::NULL_METADATA =
