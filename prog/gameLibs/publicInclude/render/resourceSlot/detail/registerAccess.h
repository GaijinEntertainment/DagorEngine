...
typedef dag::FixedMoveOnlyFunction<MAX_CALLBACK_SIZE, dafg::NodeHandle(resource_slot::State)> AccessCallback;

[[nodiscard]] NodeHandleWithSlotsAccess register_access(dafg::NameSpace ns, const char *name, ActionList &&action_list,
