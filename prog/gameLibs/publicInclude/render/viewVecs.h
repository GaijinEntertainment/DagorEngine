...
extern void set_inv_globtm_to_shader(const TMatrix4 &viewTm, const TMatrix4 &projTm, bool optional); // if optional, will not set
                                                                                                     // non-existent variables
// TODO remove this, uses gettm
extern void set_inv_globtm_to_shader(bool optional); // if optional, will not set non-existent variables
