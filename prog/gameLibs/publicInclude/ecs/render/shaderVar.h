...
my_shader_var_value:c=r,g,b,a(int)   //ShaderGlobal::set_float4(varId, my_shader_var_value);
my_shader_var_value:i=int            //ShaderGlobal::set_int(varId, my_shader_var_value);
my_shader_var_value:r=float          //ShaderGlobal::set_float(varId, my_shader_var_value);
my_shader_var_value:p4=r,g,b,a(float)//ShaderGlobal::set_float4(varId, my_shader_var_value);
...
public:
  ...
  bool set_float(float value) const { return ShaderGlobal::set_float(varId, value); }
  bool set_float4(const Point2 &rg, const Point2 &ba = Point2(0, 0)) { return ShaderGlobal::set_float4(varId, rg, ba); }
  bool set_float4(const Point3 &rgb, float a = 0.f) const { return ShaderGlobal::set_float4(varId, rgb, a); }
  bool set_float4(const Point4 &value) const { return ShaderGlobal::set_float4(varId, value); }
  bool set_float4(const Color4 &value) const { return ShaderGlobal::set_float4(varId, value); }
  bool set_float4(float r, float g, float b, float a = 0.f) const { return ShaderGlobal::set_float4(varId, r, g, b, a); }
  ...
  bool set_float4(const E3DCOLOR &value) const { return ShaderGlobal::set_float4(varId, color4(value)); }
};
