...
const uint32_t U_IMAGE_OFFSET = T_INPUT_ATTACHMENT_OFFSET + T_REGISTER_INDEX_MAX;
...
const uint32_t U_BUFFER_WITH_COUNTER_OFFSET = U_BUFFER_OFFSET + U_REGISTER_INDEX_MAX;

// like dx12RT acceleration structure are put in t namespace for now
const uint32_t T_ACCELERATION_STRUCTURE_OFFSET = U_BUFFER_WITH_COUNTER_OFFSET + U_REGISTER_INDEX_MAX;
...
namespace bindless
{
constexpr uint32_t MAX_SETS = 2;
constexpr uint32_t TEXTURE_DESCRIPTOR_SET_META_INDEX = 100;
constexpr uint32_t SAMPLER_DESCRIPTOR_SET_META_INDEX = TEXTURE_DESCRIPTOR_SET_META_INDEX + 1;

constexpr uint32_t TEXTURE_DESCRIPTOR_SET_ACTUAL_INDEX = 0;
constexpr uint32_t SAMPLER_DESCRIPTOR_SET_ACTUAL_INDEX = 1;
