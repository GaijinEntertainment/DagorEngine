...
BVH_INLINE void add_instance(ContextId context_id, Context::InstanceMap &instanceMap, uint64_t mesh_id, mat43f_cref transform,
  const Point4 *per_instance_data, MeshSkinningInfo *skinning_info, MeshHeliRotorInfo *heli_rotor_info, TreeInfo *tree_info,
  LeavesInfo *leaves_info, FlagInfo *flag_info, DeformedInfo *deformed_info, MeshMetaAllocator::AllocId meta_alloc_id)
{
...
{
  add_instance(context_id, context_id->riGenInstances[thread_ix], mesh_id, transform, nullptr, nullptr, nullptr, nullptr, nullptr,
    nullptr, nullptr, -1);
}
...
{
  add_instance(context_id, context_id->riGenInstances[thread_ix], mesh_id, transform, nullptr, nullptr, nullptr, tree_info, nullptr,
    nullptr, nullptr, meta_alloc_id);
}

BVH_INLINE void add_riGen_instance(ContextId context_id, uint64_t mesh_id, mat43f_cref transform, LeavesInfo *leaves_info,
  MeshMetaAllocator::AllocId meta_alloc_id, int thread_ix)
{
  add_instance(context_id, context_id->riGenInstances[thread_ix], mesh_id, transform, nullptr, nullptr, nullptr, nullptr, leaves_info,
    nullptr, nullptr, meta_alloc_id);
}
...
BVH_INLINE void add_riExtra_instance(ContextId context_id, uint64_t mesh_id, mat43f_cref transform, TreeInfo *tree_info,
  MeshMetaAllocator::AllocId meta_alloc_id, int thread_ix)
{
  add_instance(context_id, context_id->riExtraTreeInstances[thread_ix], mesh_id, transform, nullptr, nullptr, nullptr, tree_info,
...
BVH_INLINE void add_riExtra_instance(ContextId context_id, uint64_t mesh_id, mat43f_cref transform, FlagInfo *flag_info,
  MeshMetaAllocator::AllocId meta_alloc_id, int thread_ix)
{
  add_instance(context_id, context_id->riExtraTreeInstances[thread_ix], mesh_id, transform, nullptr, nullptr, nullptr, nullptr,
...
BVH_INLINE void add_dynrend_instance(ContextId context_id, dynrend::ContextId dynrend_context_id, uint64_t mesh_id,
  mat43f_cref transform, const Point4 *per_instance_data)
{
  add_instance(context_id, context_id->dynrendInstances[dynrend_context_id], mesh_id, transform, per_instance_data, nullptr, nullptr,
    nullptr, nullptr, nullptr, nullptr, -1);
}

BVH_INLINE void add_dynrend_instance(ContextId context_id, dynrend::ContextId dynrend_context_id, uint64_t mesh_id,
  mat43f_cref transform, const Point4 *per_instance_data, MeshSkinningInfo &skinning_info, MeshMetaAllocator::AllocId meta_alloc_id)
{
  add_instance(context_id, context_id->dynrendInstances[dynrend_context_id], mesh_id, transform, per_instance_data, &skinning_info,
    nullptr, nullptr, nullptr, nullptr, nullptr, meta_alloc_id);
}

BVH_INLINE void add_dynrend_instance(ContextId context_id, dynrend::ContextId dynrend_context_id, uint64_t mesh_id,
  mat43f_cref transform, const Point4 *per_instance_data, MeshHeliRotorInfo &heli_rotor_info, MeshMetaAllocator::AllocId meta_alloc_id)
{
  add_instance(context_id, context_id->dynrendInstances[dynrend_context_id], mesh_id, transform, per_instance_data, nullptr,
    &heli_rotor_info, nullptr, nullptr, nullptr, nullptr, meta_alloc_id);
}

BVH_INLINE void add_dynrend_instance(ContextId context_id, dynrend::ContextId dynrend_context_id, uint64_t mesh_id,
  mat43f_cref transform, const Point4 *per_instance_data, DeformedInfo &deformed_info, MeshMetaAllocator::AllocId meta_alloc_id)
{
  add_instance(context_id, context_id->dynrendInstances[dynrend_context_id], mesh_id, transform, per_instance_data, nullptr, nullptr,
