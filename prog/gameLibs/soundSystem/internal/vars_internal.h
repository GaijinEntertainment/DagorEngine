...
bool get_var_desc(const FMOD::Studio::EventDescription &event_description, const char *var_name, VarDesc &);
bool get_var_desc(const FMOD::Studio::EventDescription &event_description, const VarId &var_id, VarDesc &);
} // namespace sndsys
