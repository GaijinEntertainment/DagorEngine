...
struct AnimationDataBaseAnnotation final : das::ManagedStructureAnnotation<AnimationDataBase, false, false>
{
  AnimationDataBaseAnnotation(das::ModuleLibrary &ml) : ManagedStructureAnnotation("AnimationDataBase", ml, "AnimationDataBase")
  {
    ...
    addFieldEx("referenceAnimGraph", "referenceAnimGraph", offsetof(AnimationDataBase, referenceAnimGraph),
      das::makeType<const AnimV20::AnimationGraph *>(ml));
    addProperty<DAS_BIND_MANAGED_PROP(getReferenceSkeleton)>("referenceSkeleton", "getReferenceSkeleton");
  }
};
...
struct MotionMatchingControllerAnnotation final : das::ManagedStructureAnnotation<MotionMatchingController, false, false>
{
    ...
    ManagedStructureAnnotation("MotionMatchingController", ml, "MotionMatchingController")
  {
    ...
    addField<DAS_BIND_MANAGED_FIELD(rootAdjustmentPos)>("rootAdjustmentPos");
    addField<DAS_BIND_MANAGED_FIELD(rootAdjustmentRot)>("rootAdjustmentRot");
...
struct MatchingResultAnnotation final : das::ManagedStructureAnnotation<MatchingResult, false, false>
{
  MatchingResultAnnotation(das::ModuleLibrary &ml) : ManagedStructureAnnotation("MatchingResult", ml, "MatchingResult")
  {
    addField<DAS_BIND_MANAGED_FIELD(clip)>("clip");
    addField<DAS_BIND_MANAGED_FIELD(frame)>("frame");
    addField<DAS_BIND_MANAGED_FIELD(metrica)>("metrica");
  }
};
...
public:
  MotionMatchingModule() : das::Module("MotionMatching")
  {
    ...
    using method_getPresetIdxFromTags = DAS_CALL_MEMBER(AnimationDataBase::getPresetIdxFromTags);
    das::addExtern<DAS_CALL_METHOD(method_getPresetIdxFromTags)>(*this, lib, "getPresetIdxFromTags", das::SideEffects::none,
      DAS_CALL_MEMBER_CPP(AnimationDataBase::getPresetIdxFromTags));
    ...
    using method_updateAnimationSpeed = DAS_CALL_MEMBER(MotionMatchingController::updateAnimationSpeed);
    das::addExtern<DAS_CALL_METHOD(method_updateAnimationSpeed)>(*this, lib, "updateAnimationSpeed", das::SideEffects::modifyArgument,
      DAS_CALL_MEMBER_CPP(MotionMatchingController::updateAnimationSpeed));
    ...
    using method_getClosestFrame = DAS_CALL_MEMBER(MotionMatchingController::getClosestFrame);
    das::addExtern<DAS_CALL_METHOD(method_getClosestFrame)>(*this, lib, "getClosestFrame", das::SideEffects::none,
      DAS_CALL_MEMBER_CPP(MotionMatchingController::getClosestFrame));
    ...
    using method_willCurrentAnimationEnd = DAS_CALL_MEMBER(MotionMatchingController::willCurrentAnimationEnd);
    das::addExtern<DAS_CALL_METHOD(method_willCurrentAnimationEnd)>(*this, lib, "willCurrentAnimationEnd", das::SideEffects::none,
      DAS_CALL_MEMBER_CPP(MotionMatchingController::willCurrentAnimationEnd));
    using method_isAnimationTagsMatch = DAS_CALL_MEMBER(MotionMatchingController::isAnimationTagsMatch);
    das::addExtern<DAS_CALL_METHOD(method_isAnimationTagsMatch)>(*this, lib, "isAnimationTagsMatch", das::SideEffects::none,
      DAS_CALL_MEMBER_CPP(MotionMatchingController::isAnimationTagsMatch));

    das::addExtern<DAS_BIND_FUN(motion_matching), das::SimNode_ExtFuncCallAndCopyOrMove>(*this, lib, "motion_matching",
      das::SideEffects::none, "motion_matching");
    das::addExtern<DAS_BIND_FUN(prepare_features_for_mm_search)>(*this, lib, "prepare_features_for_mm_search",
      das::SideEffects::modifyArgument, "prepare_features_for_mm_search");
    das::addExtern<DAS_BIND_FUN(calculate_trajectory_features_cost)>(*this, lib, "calculate_trajectory_features_cost",
      das::SideEffects::none, "calculate_trajectory_features_cost");
    das::addExtern<DAS_BIND_FUN(calculate_features_cost_detailed)>(*this, lib, "calculate_features_cost_detailed",
      das::SideEffects::modifyArgument, "calculate_features_cost_detailed");
    ...
    das::addExtern<DAS_BIND_FUN(simple_spring_damper_exact)>(*this, lib, "simple_spring_damper_exact",
      das::SideEffects::modifyArgument, "simple_spring_damper_exact");
    das::addExtern<DAS_BIND_FUN(bind_dascript::get_trajectory_features)>(*this, lib, "get_trajectory_features",
      das::SideEffects::modifyArgument, "bind_dascript::get_trajectory_features");
    das::addExtern<DAS_BIND_FUN(bind_dascript::get_node_features)>(*this, lib, "get_node_features", das::SideEffects::modifyArgument,
      "bind_dascript::get_node_features");
  ...
  {
    tw << "#include <anim/motionMatching/dasModules/motionMatching.h>\n";
