...
static ecs::LTComponentList motion_matching__dataBaseTemplateName_component(ECS_HASH("motion_matching__dataBaseTemplateName"), motion_matching__dataBaseTemplateName_get_type(), "prog/gameLibs/anim/motionMatching/debug/es/debugAnimationES.cpp.inl", "enable_mm_on_player_ecs_query", 0);
...
(
  ...
  "prog/gameLibs/anim/motionMatching/debug/es/debugAnimationES.cpp.inl",
...
inline void imgui_prepare_skeleton_visualization_ecs_query(ecs::EntityManager &manager, ecs::EntityId eid, Callable function)
{
  perform_query(&manager, eid, imgui_prepare_skeleton_visualization_ecs_query_desc.getHandle(),
...
(
  ...
  empty_span());
template<typename Callable>
inline void disable_mm_on_player_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, disable_mm_on_player_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
...
(
  ...
  empty_span());
template<typename Callable>
inline void enable_mm_on_player_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, enable_mm_on_player_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void get_current_imgui_character_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, get_current_imgui_character_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void process_current_character_ecs_query(ecs::EntityManager &manager, ecs::EntityId eid, Callable function)
{
  perform_query(&manager, eid, process_current_character_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        constexpr size_t comp = 0;
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void update_clip_for_debug_trajectory_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, update_clip_for_debug_trajectory_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
static constexpr ecs::component_t motion_matching__dataBaseTemplateName_get_type(){return ecs::ComponentTypeInfo<eastl::basic_string<char>>::type; }
