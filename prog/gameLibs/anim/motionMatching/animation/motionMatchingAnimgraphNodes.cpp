...
#include "motionMatchingAnimgraphNodes.h"
...
void load_motion_matching_animgraph_nodes(AnimationDataBase &data_base, AnimV20::AnimationGraph *anim_graph)
{
  ...
  // Explicitly delete prev resource, otherwise if animGraph resource is same the deleter is not called and refCnt leaks
  data_base.animGraphGameRes.reset();
  data_base.animGraphGameRes.reset(GameResourceFactory::get_game_resource(anim_graph->resId, nullptr)); // adds ref
