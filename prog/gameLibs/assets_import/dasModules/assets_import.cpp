...
public:
  AssetsImportModule() : das::Module("AssetsImport")
  {
    ...
    das::addExtern<DAS_BIND_FUN(get_asset_manager)>(*this, lib, "get_asset_manager", das::SideEffects::accessExternal,
      "get_asset_manager");
    das::addExtern<DAS_BIND_FUN(reload_animchar_resources)>(*this, lib, "reload_animchar_resources", das::SideEffects::modifyExternal,
      "reload_animchar_resources");
