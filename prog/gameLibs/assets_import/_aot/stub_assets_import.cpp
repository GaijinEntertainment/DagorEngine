...
Tab<int> DagorAssetMgr::getFilteredAssets(dag::ConstSpan<int>, int) const { G_ASSERT_RETURN(false, {}); }
...
void reload_animchar_resources(ecs::EntityId, bool, bool) { G_ASSERT(false); }
