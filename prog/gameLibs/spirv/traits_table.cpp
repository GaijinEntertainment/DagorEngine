...
static const char *extension_name_table[] = //
  {"SPV_KHR_ray_query", "SPV_KHR_multiview", "SPV_INTEL_optnone", "SPV_AMD_gcn_shader", "SPV_INTEL_fpga_reg", "SPV_NV_mesh_shader",
    "SPV_NV_ray_tracing", "SPV_INTEL_io_pipes", "SPV_INTEL_loop_fuse", "SPV_KHR_ray_tracing", "SPV_INTEL_subgroups",
    "SPV_NV_shading_rate", "SPV_KHR_linkonce_odr", "SPV_KHR_device_group", "SPV_GOOGLE_user_type", "SPV_KHR_8bit_storage",
    "SPV_KHR_shader_clock", "SPV_KHR_subgroup_vote", "SPV_AMD_shader_ballot", "SPV_KHR_expect_assume", "SPV_KHR_16bit_storage",
    "SPV_KHR_shader_ballot", "SPV_NV_viewport_array2", "SPV_INTEL_debug_module", "SPV_KHR_float_controls", "SPV_NV_bindless_texture",
    "SPV_INTEL_media_block_io", "SPV_INTEL_vector_compute", "SPV_KHR_bit_instructions", "SPV_INTEL_blocking_pipes",
    "SPV_INTEL_float_controls2", "SPV_INTEL_inline_assembly", "SPV_NV_shader_sm_builtins", "SPV_NV_cooperative_matrix",
    "SPV_KHR_variable_pointers", "SPV_EXT_shader_image_int64", "SPV_GOOGLE_decorate_string", "SPV_EXT_descriptor_indexing",
    "SPV_KHR_integer_dot_product", "SPV_INTEL_function_pointers", "SPV_KHR_vulkan_memory_model", "SPV_INTEL_kernel_attributes",
    "SPV_KHR_post_depth_coverage", "SPV_INTEL_fp_fast_math_mode", "SPV_NV_stereo_view_rendering", "SPV_AMD_shader_fragment_mask",
    "SPV_KHR_terminate_invocation", "SPV_INTEL_fpga_loop_controls", "SPV_KHR_fragment_shading_rate", "SPV_AMD_shader_trinary_minmax",
    "SPV_EXT_shader_stencil_export", "SPV_INTEL_usm_storage_classes", "SPV_NV_shader_image_footprint",
    "SPV_NV_ray_tracing_motion_blur", "SPV_INTEL_fpga_memory_accesses", "SPV_INTEL_fpga_buffer_location",
    "SPV_KHR_shader_draw_parameters", "SPV_GOOGLE_hlsl_functionality1", "SPV_EXT_fragment_fully_covered",
    "SPV_EXT_shader_atomic_float_add", "SPV_AMD_texture_gather_bias_lod", "SPV_INTEL_variable_length_array",
    "SPV_KHR_physical_storage_buffer", "SPV_EXT_physical_storage_buffer", "SPV_INTEL_fpga_memory_attributes",
    "SPV_INTEL_long_constant_composite", "SPV_INTEL_fpga_cluster_attributes", "SPV_EXT_shader_atomic_float16_add",
    "SPV_NV_compute_shader_derivatives", "SPV_EXT_fragment_shader_interlock", "SPV_KHR_shader_atomic_counter_ops",
    "SPV_KHR_no_integer_wrap_decoration", "SPV_NV_geometry_shader_passthrough", "SPV_NV_shader_subgroup_partitioned",
    "SPV_NV_fragment_shader_barycentric", "SPV_AMD_shader_image_load_store_lod", "SPV_AMD_gpu_shader_half_float_fetch",
    "SPV_EXT_demote_to_helper_invocation", "SPV_KHR_fragment_shader_barycentric", "SPV_EXT_fragment_invocation_density",
    "SPV_INTEL_shader_integer_functions2", "SPV_EXT_shader_viewport_index_layer", "SPV_EXT_shader_atomic_float_min_max",
    "SPV_NV_sample_mask_override_coverage", "SPV_KHR_storage_buffer_storage_class", "SPV_INTEL_unstructured_loop_controls",
    "SPV_NVX_multiview_per_view_attributes", "SPV_KHR_subgroup_uniform_control_flow", "SPV_INTEL_arbitrary_precision_integers",
    "SPV_KHR_workgroup_memory_explicit_layout", "SPV_AMD_shader_explicit_vertex_parameter",
    "SPV_INTEL_arbitrary_precision_fixed_point", "SPV_INTEL_device_side_avc_motion_estimation",
    "SPV_INTEL_arbitrary_precision_floating_point"};
static const size_t extension_name_table_len[] = //
  {17, 17, 17, 18, 18, 18, 18, 18, 19, 19, 19, 19, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 22, 22, 22, 23, 24, 24, 24, 24, 25, 25, 25,
    25, 25, 26, 26, 27, 27, 27, 27, 27, 27, 27, 28, 28, 28, 28, 29, 29, 29, 29, 29, 30, 30, 30, 30, 30, 30, 31, 31, 31, 31, 31, 32, 33,
    33, 33, 33, 33, 33, 34, 34, 34, 34, 35, 35, 35, 35, 35, 35, 35, 35, 36, 36, 36, 37, 37, 38, 40, 40, 41, 43, 44};
