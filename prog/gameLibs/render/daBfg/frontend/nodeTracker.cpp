...
void NodeTracker::validateLifetimes(ValidityInfo &validity) const
{
      ...
      for (auto resId : nodeData.createdResources)
      {
        ...
        const auto scanResourceUsages = [this, &validity](ResNameId res_id, const auto &process_readers,
          ...
          while (true)
          {
            ...
            if (!renamingChains.isMapped(resIdCandidate) || !validity.resourceValid[renamingChains[resIdCandidate]])
              break;
