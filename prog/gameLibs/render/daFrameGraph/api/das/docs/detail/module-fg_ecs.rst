Nodes can be stored in ecs **singleton** and in this case there is special function annotation :ref:`fg_ecs_node <handle-fg_ecs-fg_ecs_node>` for hot reloading.
