...
XMMATRIX dafg::get_xmmatrix_helper(int var)
{
  const auto value = ShaderGlobal::get_float4x4(var);
  XMMATRIX result;
...
bool dafg::ShaderVarBindingValidationHelper<Point4, Point4>::validate(const Point4 &a, const Point4 &b)
{
  return lengthSq(b - a) == 0;
}

bool dafg::ShaderVarBindingValidationHelper<Point3, Point3>::validate(const Point3 &a, const Point3 &b)
{
  return lengthSq(b - a) == 0;
}


bool dafg::ShaderVarBindingValidationHelper<Point2, Point2>::validate(const Point2 &a, const Point2 &b)
{
  return lengthSq(b - a) == 0;
}

bool dafg::ShaderVarBindingValidationHelper<Color4, Color4>::validate(const Color4 &a, const Color4 &b)
{
  return lengthSq(b - a) == 0;
}

bool dafg::ShaderVarBindingValidationHelper<Color3, Color3>::validate(const Color3 &a, const Color3 &b)
{
  return lengthSq(b - a) == 0;
}

bool dafg::ShaderVarBindingValidationHelper<TMatrix4, TMatrix4>::validate(const TMatrix4 &a, const TMatrix4 &b)
{
  for (int i = 0; i < 4; ++i)
...
bool dafg::ShaderVarBindingValidationHelper<DirectX::XMFLOAT4X4, DirectX::XMFLOAT4X4>::validate(const DirectX::XMFLOAT4X4 &a,
...
bool dafg::ShaderVarBindingValidationHelper<DirectX::XMFLOAT4, DirectX::XMFLOAT4>::validate(const DirectX::XMFLOAT4 &a,
...
bool dafg::ShaderVarBindingValidationHelper<DirectX::XMMATRIX, DirectX::XMMATRIX>::validate(const DirectX::XMMATRIX &a,
