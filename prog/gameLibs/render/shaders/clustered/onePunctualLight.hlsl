  ...
  #elif TOON_BRDF
    half3 result = toonBRDF( NoV, NoL, gbuffer.albedo, gbuffer.linearRoughness, specularColor, dynamicLightsSpecularStrength, lightDir, view, half3(gbuffer.normal), gbuffer.translucencyColor , gbuffer.sheen);
  #else
