#ifndef __LUMINANCE_HEATMAP_H__
#define __LUMINANCE_HEATMAP_H__

// Based on https://github.com/microsoft/Windows-universal-samples/blob/main/Samples/D2DAdvancedColorImages/cpp/D2DAdvancedColorImages/LuminanceHeatmapEffect.hlsl
...
float4 luminance_heatmap(float value)
{
  ...
  // Scale by whitepoint of 80 nits.
  float nits = value * 80.0f;
