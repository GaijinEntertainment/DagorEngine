...
#define ENVI_OVERWRITE_BIT_POS_IN_EXTRA 3u
#define ENVI_OVERWRITE_BIT_SHIFT (ENVI_OVERWRITE_BIT_POS_IN_EXTRA - 1)
#define ENVI_OVERWRITE_BIT_MASK (1u << ENVI_OVERWRITE_BIT_SHIFT)
