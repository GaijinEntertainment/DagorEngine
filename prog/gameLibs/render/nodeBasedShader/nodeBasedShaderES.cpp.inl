...
inline void gather_nbs_sphere_managers_ecs_query(ecs::EntityManager &manager, Callable c);

eastl::vector<String> nodebasedshaderutils::getAvailableVolumeChannels()
{
  eastl::vector_set<String> managers;

  gather_nbs_sphere_managers_ecs_query(*g_entity_mgr, [&](const ecs::string &nbs_spheres_manager__class_name) {
