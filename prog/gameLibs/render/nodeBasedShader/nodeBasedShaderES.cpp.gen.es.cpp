...
inline void gather_nbs_sphere_managers_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, gather_nbs_sphere_managers_ecs_query_desc.getHandle(),
