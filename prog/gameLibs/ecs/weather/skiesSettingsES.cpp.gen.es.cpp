...
{
  G_FAST_ASSERT(evt.is<EventSkiesLoaded>());
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    skies_settings_skies_loaded_es_event_handler(static_cast<const EventSkiesLoaded&>(evt)
...
(
  ...
  empty_span(),
  ecs::EventSetBuilder<EventSkiesLoaded>::build(),
  0
,nullptr,nullptr,"clouds_form_es,clouds_weather_gen_es,sky_atmosphere_es,strata_clouds_es");
...
static constexpr ecs::ComponentDesc disappear_clouds_hole_es_comps[] =
{
...
(
  "disappear_clouds_hole_es",
  "prog/gameLibs/ecs/weather/skiesSettingsES.cpp.inl",
  ecs::EntitySystemOps(nullptr, disappear_clouds_hole_es_all_events),
  empty_span(),
  empty_span(),
  make_span(disappear_clouds_hole_es_comps+0, 1)/*rq*/,
  empty_span(),
