...
static ecs::EntityId remote_recreate_impl(ecs::EntityId eid, const char *new_templ_name, const char *sync_templ_name,
  ecs::ComponentsInitializer &&inst_comps, remote_recreate_entity_async_cb_t &&cb)
{
...
ecs::EntityId remote_recreate_entity_from(ecs::EntityId eid, const char *new_templ_name, ecs::ComponentsInitializer &&inst_comps,
...
ecs::EntityId remote_change_sub_template(ecs::EntityId eid, const char *remove_templ_name, const char *add_templ_name,
  ecs::ComponentsInitializer &&inst_comps, remote_recreate_entity_async_cb_t &&cb, bool force)
{
