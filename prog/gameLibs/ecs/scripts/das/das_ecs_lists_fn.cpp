...
#define BIND_LIST_FUNCS(T)                                                                                                        \
  ...
  das::addExtern<DAS_BIND_FUN(pushListAt<T>), das::SimNode_ExtFuncCall, das::permanentArgFn>(*this, lib, "push",                  \
    das::SideEffects::modifyArgument, "bind_dascript::pushListAt< ::" #T ">");                                                    \
  ...
  das::addExtern<DAS_BIND_FUN(emplaceListAt<T>), das::SimNode_ExtFuncCall, das::permanentArgFn>(*this, lib, "emplace",            \
    das::SideEffects::modifyArgument, "bind_dascript::emplaceListAt< ::" #T ">");                                                 \
...
#undef BIND_LIST_FUNCS
  ...
  das::addExtern<DAS_BIND_FUN(pushStringListAt)>(*this, lib, "push", das::SideEffects::modifyArgument,
    "bind_dascript::pushStringListAt");
  ...
  das::addExtern<DAS_BIND_FUN(emplaceStringListAt)>(*this, lib, "emplace", das::SideEffects::modifyArgument,
    "bind_dascript::emplaceStringListAt");
}
} // namespace bind_dascript
