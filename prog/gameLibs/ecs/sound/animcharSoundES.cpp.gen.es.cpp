...
static ecs::LTComponentList animchar_component(ECS_HASH("animchar"), animchar_get_type(), "prog/gameLibs/ecs/sound/animcharSoundES.cpp.inl", "", 0);
static constexpr ecs::component_t gun__owner_get_type();
static ecs::LTComponentList gun__owner_component(ECS_HASH("gun__owner"), gun__owner_get_type(), "prog/gameLibs/ecs/sound/animcharSoundES.cpp.inl", "", 0);
static constexpr ecs::component_t is_watched_sound_get_type();
static ecs::LTComponentList is_watched_sound_component(ECS_HASH("is_watched_sound"), is_watched_sound_get_type(), "prog/gameLibs/ecs/sound/animcharSoundES.cpp.inl", "", 0);
...
(
  ...
  "prog/gameLibs/ecs/sound/animcharSoundES.cpp.inl",
