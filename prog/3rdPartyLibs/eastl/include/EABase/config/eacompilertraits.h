...
#define INCLUDED_eacompilertraits_H
	...
	#ifndef EA_FP128
		#if (defined __FLOAT128__ || defined _GLIBCXX_USE_FLOAT128) && !defined(EA_PLATFORM_C)
			#define EA_FP128 1
		#else
			#define EA_FP128 0
		#endif
	...
	// 
	#ifndef EA_ABM
		#if defined(__ABM__) || defined(EA_PLATFORM_XBOXONE) || defined(EA_PLATFORM_C) || defined(CS_UNDEFINED_STRING)
			#define EA_ABM 1
		#else
			#define EA_ABM 0
		#endif
