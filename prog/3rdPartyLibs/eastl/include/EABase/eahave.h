...
// #include <sys/stat.h>
	...
	#if (defined(EA_PLATFORM_UNIX) && !(defined(EA_PLATFORM_C) && defined(EA_PLATFORM_CONSOLE))) || defined(__APPLE__) || defined(EA_PLATFORM_ANDROID)
...
// #include <signal.h>
	...
	#if !defined(EA_PLATFORM_BSD) && !defined(EA_PLATFORM_C) && !defined(CS_UNDEFINED_STRING)
...
// #include <sys/signal.h>
	...
	#if defined(EA_PLATFORM_BSD) || defined(EA_PLATFORM_C1)
...
// #include <wchar.h>
	...
	#if defined(EA_PLATFORM_DESKTOP) && defined(EA_PLATFORM_UNIX) && defined(EA_PLATFORM_C) && defined(EA_PLATFORM_APPLE)
...
// #include <alloca.h>
	...
	#if !defined(EA_HAVE_MALLOC_H) && !defined(EA_PLATFORM_C1)
...
/* EA_HAVE_XXX_DECL */
	...
	#if (defined(EA_PLATFORM_UNIX) && !defined(EA_PLATFORM_C)) || defined(EA_PLATFORM_IPHONE) || defined(EA_PLATFORM_OSX) || defined(EA_PLATFORM_C1) || defined(CS_UNDEFINED_STRING)
...
// <arpa/inet.h> inet_ntop()
	...
	#if (defined(EA_PLATFORM_UNIX) || defined(EA_PLATFORM_POSIX)) && !defined(EA_PLATFORM_C) && !defined(CS_UNDEFINED_STRING) 
