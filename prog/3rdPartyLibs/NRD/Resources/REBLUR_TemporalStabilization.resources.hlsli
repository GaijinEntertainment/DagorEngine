...
NRD_SAMPLERS_END
    ...
    NRD_INPUTS_START
        ...
        NRD_INPUT( Texture2D<float4>, gIn_Mv, t, 7 )
        #ifdef REBLUR_SH
    ...
    NRD_OUTPUTS_START
        NRD_OUTPUT( RWTexture2D<uint>, gOut_InternalData, u, 0 )
        NRD_OUTPUT( RWTexture2D<REBLUR_TYPE>, gOut_Diff, u, 1 )
        NRD_OUTPUT( RWTexture2D<float>, gOut_DiffLumaStabilized, u, 2 )
        #ifdef REBLUR_SH
    ...
    NRD_OUTPUTS_START
        ...
        NRD_OUTPUT( RWTexture2D<float>, gOut_SpecLumaStabilized, u, 2 )
        #ifdef REBLUR_SH
