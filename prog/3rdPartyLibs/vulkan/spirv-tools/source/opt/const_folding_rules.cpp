...
UnaryScalarFoldingRule FoldFTranscendentalUnary(double (__cdecl *fp)(double)) {
  return
...
BinaryScalarFoldingRule FoldFTranscendentalBinary(double (__cdecl *fp)(double, double)) {
  return
      [fp](const analysis::Type* result_type, const analysis::Constant* a,
           const analysis::Constant* b,
           analysis::ConstantManager* const_mgr) -> const analysis::Constant* {
