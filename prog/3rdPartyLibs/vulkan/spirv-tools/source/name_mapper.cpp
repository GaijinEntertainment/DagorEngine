...
spv_result_t FriendlyNameMapper::ParseInstruction(
  ...
  // emitAsUnknown() (HANDLE_UNKNOWN_OPCODES retry path) clears operand
  // metadata and sets num_operands to 0; the opcode arms below index
  // inst.words[N] directly and would read out of bounds on such retries.
