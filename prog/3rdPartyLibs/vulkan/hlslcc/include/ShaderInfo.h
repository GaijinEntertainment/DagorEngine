...
struct ResourceBinding
{
	...
	//int & uint structured UAVs have same binding & buffer descriptions
	//when buffer declared as RWStructuredBuffer<int>
	//this is used to pass proper type from hlsl source, without dependency matching
	bool isIntUAV;
...
public:
  ...
  bool GetResourceFromBindingPoint(const ResourceGroup eGroup, const uint32_t ui32BindPoint, const ResourceBinding** ppsOutBinding) const;
