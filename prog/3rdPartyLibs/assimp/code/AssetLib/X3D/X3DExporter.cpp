...
void X3DExporter::AttrHelper_FloatToString(const float pValue, eastl::string &pTargetString) {
...
void X3DExporter::AttrHelper_Vec2DArrToString(const aiVector2D *pArray, const size_t pArray_Size, eastl::string &pTargetString) {
    pTargetString.clear();
...
void X3DExporter::AttrHelper_Col3DArrToString(const aiColor3D *pArray, const size_t pArray_Size, eastl::string &pTargetString) {
    pTargetString.clear();
    pTargetString.reserve(pArray_Size * 6); // (Number + space) * 3.
    for (size_t idx = 0; idx < pArray_Size; idx++)
        pTargetString.append(to_string(pArray[idx].r) + " " + to_string(pArray[idx].g) + " " + to_string(pArray[idx].b) + " ");
...
void X3DExporter::AttrHelper_Color3ToAttrList(eastl::list<SAttribute> &pList, const eastl::string &pName, const aiColor3D &pValue, const aiColor3D &pDefaultValue) {
    string tstr;
...
void X3DExporter::AttrHelper_FloatToAttrList(eastl::list<SAttribute> &pList, const string &pName, const float pValue, const float pDefaultValue) {
    string tstr;
