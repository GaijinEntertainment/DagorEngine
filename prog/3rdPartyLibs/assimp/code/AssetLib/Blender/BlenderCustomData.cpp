...
/**
        ...
        */
eastl::array<CustomDataTypeDescription, CD_NUMTYPES> customDataTypeDescriptions = { { DECL_STRUCT_CUSTOMDATATYPEDESCRIPTION(MVert),
...
bool readCustomData(eastl::shared_ptr<ElemBase> &out, const int cdtype, const size_t cnt, const FileDatabase &db) {
...
eastl::shared_ptr<CustomDataLayer> getCustomDataLayer(const CustomData &customdata, const CustomDataType cdtype, const eastl::string &name) {
...
const ElemBase *getCustomDataLayerData(const CustomData &customdata, const CustomDataType cdtype, const eastl::string &name) {
    const eastl::shared_ptr<CustomDataLayer> pLayer = getCustomDataLayer(customdata, cdtype, name);
