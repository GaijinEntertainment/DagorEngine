...
private:
    void UpdateNode(aiNode *pcNode, const eastl::vector<eastl::pair<aiMesh *, unsigned int>> &source_mesh_map);
    void SplitMesh(unsigned int index, aiMesh *mesh, eastl::vector<eastl::pair<aiMesh *, unsigned int>> &source_mesh_map);
