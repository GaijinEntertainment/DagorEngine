...
size_t ENET_CALLBACK // dagor
enet_range_coder_compress (void * context, enet_uint16 peer_id, const ENetBuffer * inBuffers, size_t inBufferCount,
...
size_t ENET_CALLBACK // dagor
enet_range_coder_decompress (void * context, enet_uint16 peer_id, const enet_uint8 * inData, size_t inLimit,
