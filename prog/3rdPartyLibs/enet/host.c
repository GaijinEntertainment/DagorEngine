...
enet_host_create (const ENetAddress * address, size_t peerCount, size_t channelLimit, enet_uint32 incomingBandwidth, enet_uint32 outgoingBandwidth)
{
    ...
    host -> outgoingBandwidthPerPeer = 0; /* unlimited */
...
*/
void
enet_host_bandwidth_limit (ENetHost * host, enet_uint32 incomingBandwidth, enet_uint32 outgoingBandwidth, enet_uint32 outgoingBandwidthPerPeer)
{
    host -> incomingBandwidth = incomingBandwidth;
    host -> outgoingBandwidth = outgoingBandwidth;
    host -> outgoingBandwidthPerPeer = outgoingBandwidthPerPeer;
...
enet_host_bandwidth_throttle (ENetHost * host)
{
    ...
    {
        enet_uint32 peerBandwidth;
        peerBandwidth = ENET_MIN ((host -> outgoingBandwidthPerPeer * elapsedTime) / 1000, bandwidth / peersRemaining);
             ...
             ++ peer)
        {
            ...
            peer -> packetThrottleLimit = (peerBandwidth > 0 && peer -> outgoingDataTotal > 0) ? (peerBandwidth *
                                            ENET_PEER_PACKET_THROTTLE_SCALE) / peer -> outgoingDataTotal : throttle;
