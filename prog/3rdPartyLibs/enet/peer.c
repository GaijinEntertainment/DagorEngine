...
static void
enet_peer_remove_incoming_commands (ENetPeer * peer, ENetList * queue, ENetListIterator startCommand, ENetListIterator endCommand)
{
...
enet_peer_reset (ENetPeer * peer)
{
    ...
    peer -> useStickyCompressionFlag = 0;
    peer -> stickyCompressionFlag = 0;

    memset (peer -> unsequencedWindow, 0, sizeof (peer -> unsequencedWindow));
    
    enet_peer_reset_queues (peer);

    memset (peer -> packetsLostHistory, 0, sizeof (peer -> packetsLostHistory));
    memset (peer -> packetsDeliveredHistory, 0, sizeof (peer -> packetsDeliveredHistory));
    peer -> packetsHistoryWritePosition = 0;
}
