							  ...
							  DBVT_IPOLICY) const
{
	...
	if (root)
	{
		...
		alignas(sizeof(const btDbvtNode*)) char tempmemory[SIMPLE_STACKSIZE * sizeof(const btDbvtNode*)];
...
#ifndef BT_DISABLE_STACK_TEMP_MEMORY
		alignas(sizeof(const btDbvtNode*)) char tempmemory[DOUBLE_STACKSIZE * sizeof(const btDbvtNode*)];
