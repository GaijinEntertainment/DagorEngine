...
public:
	...
	void processAllOverlappingPairs(btOverlapCallback* callback, btDispatcher* dispatcher, const struct btDispatcherInfo&) override
	{
		processAllOverlappingPairs(callback, dispatcher);
	}
...
public:
	...
	void processAllOverlappingPairs(btOverlapCallback*, btDispatcher*, const struct btDispatcherInfo&) override
	{
	}
