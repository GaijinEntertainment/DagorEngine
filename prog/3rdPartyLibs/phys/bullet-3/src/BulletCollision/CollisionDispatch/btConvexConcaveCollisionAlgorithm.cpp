...
{
	BT_PROFILE0("btConvexTriangleCallback::processTriangle");
    ...
    //todo: check this issue https://github.com/bulletphysics/bullet3/issues/4263
		...
		{
			BT_PROFILE0("processCollision (GJK?)");
...
{
	BT_PROFILE0("btConvexConcaveCollisionAlgorithm::processCollision");
