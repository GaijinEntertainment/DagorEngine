...
// clang-format off
#if (defined(DEBUG) || defined (_DEBUG)) && !defined(BT_DEBUG)
	#define BT_DEBUG
#endif
...
#define BT_NO_SIMD_OPERATOR_OVERLOADS
...
#if (_MSC_FULL_VER >= 170050727) && (!defined(__clang__) || defined(__SSE4_1__))//Visual Studio 2012 can compile SSE4/FMA3 (but SSE4/FMA3 is not enabled by default)
		...
		#endif//_MSC_VER
	#else // dagor
		#include <debug/dag_assert.h> // hack
		#define btFastAssert G_FAST_ASSERT
		#define btAssert G_ASSERT
	#endif
	#else
		#define btAssert(x)
	#endif
	...
	//non-windows systems
			...
			#if (defined (__APPLE__) || defined (__clang__) || defined(_MSC_VER) || defined(__linux__) || defined (_TARGET_C1) || defined(_TARGET_C2)) && (!defined (BT_USE_DOUBLE_PRECISION))
...
///The btScalar type abstracts floating point numbers, to easily switch between double and single floating point precision.
	...
	#define BT_INFINITY __builtin_inff()
	#define BT_NAN NAN
	#define btAssign128(r0, r1, r2, r3) \
