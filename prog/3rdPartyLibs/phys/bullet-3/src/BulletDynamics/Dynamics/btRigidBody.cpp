...
void btRigidBody::setDamping(btScalar lin_damping, btScalar ang_damping)
{
	...
	m_cachedLinearDamping = btPow(btScalar(1)-m_linearDamping, btScalar(1.f / 60.f));
	m_cachedAngularDamping = btPow(btScalar(1)-m_angularDamping, btScalar(1.f / 60.f));
#endif
}
...
#else
	m_linearVelocity *= m_cachedLinearDamping;
	m_angularVelocity *= m_cachedAngularDamping;
#endif
