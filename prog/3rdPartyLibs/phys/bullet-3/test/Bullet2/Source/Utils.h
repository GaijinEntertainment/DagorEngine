...
#else
#define LARGE_FLOAT17 float(1<<17)
#define RANDF_16 (random_number32() * (1.0f/float(1<<16)))
#define RANDF_01 (random_number32() * (1.0f/float(1<<16)/float(1<<16)))
#define RANDF (random_number32() * (1.0f/float(1<<8)))
#define RANDF_m1p1 (2.0f * (random_number32() * (1.0f/float(1<<16)/float(1<<16))) - 1.0f)
#endif  //_WIN32
