 ...
 ********************************************************************
  ...
  function:
    dct_decode_mmx.c 15400 2008-10-15 12:10:58Z tterribe
...
static void loop_filter_v(unsigned char *_pix,int _ystride,
  ...
  __asm__ __volatile__(
    ...
    :[s]"=&S"(esi)
    :[pix]"r"(_pix),[ystride]"r"((ogg_int32_t)_ystride),[ll]"r"(_ll),
...
static void loop_filter_h4(unsigned char *_pix,ogg_int32_t _ystride,
                           const ogg_int16_t *_ll){
  ogg_int32_t esi;
  ogg_int32_t edi;
  __asm__ __volatile__(
