...
#endif
#if defined(AF_UNIX) && OPENSSL_USE_UN
...
{
#if !defined(OPENSSL_SYS_PLAYSTATION)
    if (BIO_sock_init() != 1)
        return 0;
...
#if !defined(OPENSSL_SYS_PLAYSTATION) && !defined(OPENSSL_SYS_NSWITCH)
/*
