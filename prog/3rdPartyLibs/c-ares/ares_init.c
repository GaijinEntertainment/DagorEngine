...
#if (!defined(WIN32) || defined(_DURANGO) || defined(_GAMING_XBOX)) && !defined(WATT32) && \
...
#if defined(WIN32) && !(defined(_DURANGO) | defined(_GAMING_XBOX))
/*
 * get_REG_SZ()
 *
...
#if (!defined(WIN32) || defined(_DURANGO) || defined(_GAMING_XBOX)) && !defined(ANDROID) && !defined(__ANDROID__)
static int config_sortlist(struct apattern **sortlist, int *nsort,
                           const char *str)
{
  struct apattern pat;
