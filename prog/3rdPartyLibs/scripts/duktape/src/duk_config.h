...
/* Orbis (PS4) variant */
#if defined(DUK_F_FREEBSD) && defined(_TARGET_C1)
#define DUK_F_ORBIS
#endif
...
/* Durango (Xbox One) */
#if defined(_DURANGO) || defined(_GAMING_XBOX) || defined(_XBOX_ONE)
...
#define DUK_F_ARM
#if defined(__LP64__) || defined(_LP64) || defined(__arm64) || defined(__arm64__) || defined(__aarch64__) || defined(_M_ARM64)
#define DUK_F_ARM64
#else
#define DUK_F_ARM32
#endif
