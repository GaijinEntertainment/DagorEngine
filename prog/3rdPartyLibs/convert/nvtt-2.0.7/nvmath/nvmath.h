...
#define sqrt(X) sqrt_assert(X)
#define sqrtf(X) sqrtf_assert(X)
#define acos(X) acos_assert(X)
#define acosf(X) acosf_assert(X)
#define asin(X) asin_assert(X)
#define asinf(X) asinf_assert(X)
