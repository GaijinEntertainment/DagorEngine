...
#else
void NV_CDECL nvDebug(const char *msg, ...) {}
void nv::debug::dumpInfo() {}
void nv::debug::setMessageHandler(MessageHandler *) {}
void nv::debug::resetMessageHandler() {}
void nv::debug::setAssertHandler(AssertHandler *) {}
void nv::debug::resetAssertHandler() {}
#endif
