...
using namespace nv;
bool nvtt_estimate_single_rgb_color_only = false;  //== to be removed and replaced with true  (later)
...
{
  Color32 mask(0xFF, 0xFF, 0xFF, nvtt_estimate_single_rgb_color_only ? 0x00 : 0xFF);
