...
{
extern IMemAlloc *stripmem;

class NvFaceInfo
{
public:
  DAG_DECLARE_NEW(stripmem)
...
public:
  ...
  void Stripify(const WordVec &in_indices, const int in_cacheSize, const int in_minStripLength, const unsigned short maxIndex,
