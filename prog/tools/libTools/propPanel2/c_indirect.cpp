...
void Parameter::addParam(PropertyContainerControlBase *gr, const DataBlock &data)
{
  switch (type)
  {
...
bool Parameter::getParam(const PropertyContainerControlBase *gr, DataBlock &data)
{
  Value v;
...
//===============================================================================
void ParamGroup::addParams(PropertyContainerControlBase *gr, const DataBlock &data)
{
  for (int i = 0; i < items.size(); i++)
    if (items[i].group)
    {
      PropertyContainerControlBase *subgr = gr->createGroup(items[i].g->getId(), items[i].g->caption);
...
//===============================================================================
bool ParamGroup::getParams(const PropertyContainerControlBase *gr, DataBlock &data)
{
  bool changed = false;
  ...
  for (int i = 0; i < items.size(); i++)
    if (items[i].group)
    {
      // PropertyContainerControlBase *subgr = gr->getGroup ((int)items[i].g);
...
//===============================================================================
PropPanelScheme::~PropPanelScheme() { clear(); }

//===============================================================================
void PropPanelScheme::setParams(PropertyContainerControlBase *gr, const DataBlock &data)
{
  if (rootScheme && gr)
...
//===============================================================================
bool PropPanelScheme::getParams(const PropertyContainerControlBase *gr, DataBlock &data)
{
  if (rootScheme && gr)
