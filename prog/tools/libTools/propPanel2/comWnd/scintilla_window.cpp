...
#include <propPanel2/comWnd/scintilla_window.h>
...
void CScintillaWindow::onWmEmbeddedResize(int width, int height)
{
  ::MoveWindow((HWND)hwndScParent, 0, 0, width, height, FALSE);
  ::MoveWindow((HWND)hwndScintilla, 0, 0, width, height, FALSE);
}
