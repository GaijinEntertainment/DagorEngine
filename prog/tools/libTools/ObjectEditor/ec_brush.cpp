...
Brush::Brush(IBrushClient *bc) :
  ...
  prevCoord(-1, -1)
{
  if (!editorcore_extapi::dagRender)
...
void Brush::draw()
{
  editorcore_extapi::dagRender->startLinesRender();
  editorcore_extapi::dagRender->setLinesTm(TMatrix::IDENT);
  editorcore_extapi::dagRender->renderSphere(center, radius, color);
  editorcore_extapi::dagRender->endLinesRender();
}
...
void Brush::fillCommonParams(PropPanel::ContainerPropertyControl &group, int radius_pid, int opacity_pid, int hardness_pid,
...
void Brush::updateToPanel(PropPanel::ContainerPropertyControl &group)
{
...
//==================================================================================================
void Brush::addMaskList(int pid, PropPanel::ContainerPropertyControl &params, const char *def)
{
...
{
  return SimpleString(editorcore_extapi::make_full_start_path(String(260, "/../commonData/brushes/%s", mask)).str());
}


//==============================================================================
bool Brush::updateFromPanel(PropPanel::ContainerPropertyControl *panel, int pid)
{
  if (pid == radiusPid)
  {
