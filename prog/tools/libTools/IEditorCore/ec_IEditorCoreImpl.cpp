...
//==================================================================================================
ShaderMesh *EcGeom::createSimpleShaderMesh(Mesh &m, ShaderMaterial *mat, const char *info_str)
{
  return ShaderMesh::createSimple(m, mat, info_str);
}


void EcGeom::destroyShaderMesh(ShaderMesh *&sm) { del_it(sm); }
...
//==================================================================================================
int EcGeom::globalVertexDataGetStride(const GlobalVertexData &data) const { return data.getStride(); }
