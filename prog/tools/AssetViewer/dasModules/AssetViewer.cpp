...
public:
  AssetViewerModule() : das::Module("AssetViewer")
  {
    ...
    das::addExtern<DAS_BIND_FUN(bind_dascript::select_asset)>(*this, lib, "select_asset", das::SideEffects::worstDefault,
      "bind_dascript::select_asset");
