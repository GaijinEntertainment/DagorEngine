...
set /P a=...<nul
  ..\..\..\tools\dagor_cdk\windows-x86_64\vromfsPacker-dev.exe darg.vromfs.blk -platform:PC >log_vrom_darg
  ...
  ..\..\..\tools\dagor_cdk\windows-x86_64\vromfsPacker-dev.exe android.vromfs.blk -platform:and >log_vrom_android
