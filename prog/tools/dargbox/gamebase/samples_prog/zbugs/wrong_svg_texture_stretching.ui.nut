...
let list = [
  {
    size = const [hdpx(150), hdpx(50)]
    imgSize = [hdpx(150), hdpx(50)]
    text = "Pixel perfect"
    color = 0xFFFF0000
  }
  {
    size = const [hdpx(700), hdpx(50)]
    imgSize = [hdpx(700), hdpx(50)]
    text = "Pixel perfect"
    color = 0xFFFF0000
  }
  {
    size = const [hdpx(250), hdpx(50)]
    imgSize = [hdpx(150), hdpx(4)]
    text = "Stretched"
    color = 0xFF00FF00
  }
  {
    size = const [hdpx(700), hdpx(100)]
    imgSize = [hdpx(150), hdpx(4)]
    text = "Stretched"
    color = 0xFF00FF00
  }
  {
    size = const [hdpx(270), hdpx(40)]
    imgSize = [hdpx(300), hdpx(200)]
    text = "Gripped"
    color = 0xFF00FF00
  }
  {
    size = const [hdpx(500), hdpx(120)]
