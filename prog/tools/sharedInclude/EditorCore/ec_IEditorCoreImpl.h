#ifndef __GAIJIN_IEDITOR_CORE_IMPLEMENTATION__
#define __GAIJIN_IEDITOR_CORE_IMPLEMENTATION__
#pragma once
...
public:
  ...
  virtual DagorCurFog &curFog() const;
...
public:
  ...
  // ShaderMesh
  virtual ShaderMesh *createSimpleShaderMesh(Mesh &m, ShaderMaterial *mat, const char *info_str = NULL);

  virtual void destroyShaderMesh(ShaderMesh *&sm);

  // GlobalVertexData
  virtual int globalVertexDataGetStride(const GlobalVertexData &data) const;
...
{
public:
  virtual IDagorRender *getRender() { return &render; }
  virtual IDagorGeom *getGeom() { return &geom; }
  virtual IDagorConsole *getConsole() { return &console; }
  virtual IDagorTools *getTools() { return &tools; }
  virtual IDagorScene *getScene() { return &scene; }
  virtual const char *getExePath();
...
#endif //__GAIJIN_IEDITOR_CORE_IMPLEMENTATION__
