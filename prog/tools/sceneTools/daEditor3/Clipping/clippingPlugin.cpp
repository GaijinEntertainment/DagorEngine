...
bool ClippingPlugin::onPluginMenuClick(unsigned id)
{
  switch (id)
  {
    ...
    case CM_COMPILE_GAME_CLIPPING:
    {
      ...
      CDialogWindow *myDlg = DAGORED2->createDialog(DIALOG_WIDTH, DIALOG_HEIGHT, "Compile game collision (PC)");
...
bool ClippingPlugin::compileEditClip()
{
  ...
  CDialogWindow *myDlg = DAGORED2->createDialog(DIALOG_WIDTH, 70 + lines * 30, "Collision members");
  PropertyContainerControlBase *myPanel = myDlg->getPanel();
