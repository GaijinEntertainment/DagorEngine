...
#define DIALOG_HEIGHT 750

#define HOR_INDENT   3
#define VERT_INDENT  5
#define CLIENT_WIDTH (DIALOG_WIDTH - HOR_INDENT * 2)
...
#define MAX_REAL_LENGTH     64

#define ID_PLUGIN_NAMES 300
#define ID_PLUGIN_PATHS 500

#define LIGHT_LABELS_WIDTH       160
#define LIGHT_COLOR_SAMPLE_WIDTH 50
...
ProjectSettingsDlg::ProjectSettingsDlg(void *phandle, bool &use_dir_light) :
  CDialogWindow(phandle, DIALOG_WIDTH, DIALOG_HEIGHT, "Project settings")
{
...
PsExternalTab::PsExternalTab(PropertyContainerControlBase *tab_page) : mTabPage(tab_page), oldVals(tmpmem), nowEdit(false)
{
  ...
  filter.push_back() = "DaEditor3 level (*.level.blk)|*.level.blk";
