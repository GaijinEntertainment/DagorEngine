  ...
  #ifndef parallax_tex2dlod
    #define parallax_tex2dlod(a,b) tex2Dlod(a, b)
  #endif
  #ifndef parallax_tex2d
    #define parallax_tex2d(a,b) tex2D(a, b)
  #endif
  float2 ParallaxOcclusionMap(in float4 baseTC, in half3 viewDirNrm, in int numSteps, in int numSteps_bil, in half displacement, out half4 outTex)
  {
    ...
    half4 NB0 = parallax_tex2dlod(PARALLAX_TEX, baseTC);
    outTex = parallax_tex2dlod(PARALLAX_TEX, offset);
    ...
    for (i=0; i<numSteps_bil; i++)
    {
        ...
        outTex = parallax_tex2dlod(PARALLAX_TEX, offsetBest);
  ...
  #endif
  float2 get_parallax(float2 parallaxTS, float2 texCoord, float str)
  {
    ...
    {
      float height = 1 - parallax_tex2d(PARALLAX_TEX, tc).PARALLAX_ATTR;
