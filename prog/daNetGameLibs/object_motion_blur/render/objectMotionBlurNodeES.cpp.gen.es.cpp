...
//start of 1 rq components at [0]
  {ECS_HASH("object_motion_blur__render_node"), ecs::ComponentTypeInfo<dafg::NodeHandle>()}
};
...
inline void object_motion_blur_node_init_ecs_query(ecs::EntityId eid, Callable function)
{
  perform_query(g_entity_mgr, eid, object_motion_blur_node_init_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        ...
        {
          function(
              ECS_RW_COMP(object_motion_blur_node_init_ecs_query_comps, "object_motion_blur__render_node", dafg::NodeHandle)
