...
bool use_water_caustics()
{
  ...
  water_caustics_node_exists_ecs_query([&waterCausticsEntityExists](const dabfg::NodeHandle &caustics__node) {
    G_UNUSED(caustics__node);
...
static void update_caustics_entity(dabfg::NodeHandle &caustics__node,
  ...
  bool &combined_shadows__use_additional_textures)
{
  ...
  if (use_water_caustics())
  {
    ...
    caustics__node = makeCausticsNode();
  }
  else
  {
...
static void caustics_water_quality_changed_es(const ecs::Event &, const ecs::string &render_settings__waterQuality)
{
  ...
  create_caustics_node_ecs_query([](dabfg::NodeHandle &caustics__node, UniqueTexHolder &caustics__indoor_probe_mask,
                                   bool &needs_water_heightmap, bool &combined_shadows__use_additional_textures) {
    update_caustics_entity(caustics__node, caustics__indoor_probe_mask, needs_water_heightmap,
...
static void caustics_render_features_changed_es(const ecs::Event &evt,
  dabfg::NodeHandle &caustics__node,
  UniqueTexHolder &caustics__indoor_probe_mask,
  bool &needs_water_heightmap,
  bool &combined_shadows__use_additional_textures)
{
  ...
  const ShadersECS &caustics__indoor_probe_shader)
{
  ...
  if (caustics__node && !caustics__indoor_probe_mask)
  {
    ...
    caustics__indoor_probe_mask->disableSampler();
    {
