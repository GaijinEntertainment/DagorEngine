...
//start of 4 rw components at [0]
  {ECS_HASH("hero_cockpit_early_prepass_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
  {ECS_HASH("hero_cockpit_late_prepass_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
  {ECS_HASH("hero_cockpit_colorpass_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
  {ECS_HASH("prepare_hero_cockpit_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()}
};
static void init_hero_cockpit_nodes_es_event_handler_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    init_hero_cockpit_nodes_es_event_handler(evt
        , ECS_RW_COMP(init_hero_cockpit_nodes_es_event_handler_comps, "hero_cockpit_early_prepass_node", dabfg::NodeHandle)
    , ECS_RW_COMP(init_hero_cockpit_nodes_es_event_handler_comps, "hero_cockpit_late_prepass_node", dabfg::NodeHandle)
    , ECS_RW_COMP(init_hero_cockpit_nodes_es_event_handler_comps, "hero_cockpit_colorpass_node", dabfg::NodeHandle)
    , ECS_RW_COMP(init_hero_cockpit_nodes_es_event_handler_comps, "prepare_hero_cockpit_node", dabfg::NodeHandle)
    );
  while (++comp != compE);
}
    ...
    [&function](const ecs::QueryView& __restrict components)
    {
        constexpr size_t comp = 0;
        {
          function(
            ...
            , ECS_RW_COMP(get_animchar_draw_info_ecs_query_comps, "animchar_visbits", uint8_t)
...
inline void set_visbits_ecs_query(ecs::EntityId eid, Callable function)
{
  perform_query(g_entity_mgr, eid, set_visbits_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        ...
        {
          function(
              ECS_RW_COMP(set_visbits_ecs_query_comps, "animchar_visbits", uint8_t)
            );
...
static constexpr ecs::ComponentDesc fill_hero_cockpit_entities_ecs_query_comps[] =
{
//start of 2 rw components at [0]
  {ECS_HASH("hero_cockpit_entities"), ecs::ComponentTypeInfo<ecs::EidList>()},
  {ECS_HASH("render_hero_cockpit_into_early_prepass"), ecs::ComponentTypeInfo<bool>()}
};
static ecs::CompileTimeQueryDesc fill_hero_cockpit_entities_ecs_query_desc
(
  "fill_hero_cockpit_entities_ecs_query",
  make_span(fill_hero_cockpit_entities_ecs_query_comps+0, 2)/*rw*/,
  empty_span(),
  empty_span(),
  empty_span());
template<typename Callable>
inline void fill_hero_cockpit_entities_ecs_query(Callable function)
{
  perform_query(g_entity_mgr, fill_hero_cockpit_entities_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
          function(
              ECS_RW_COMP(fill_hero_cockpit_entities_ecs_query_comps, "hero_cockpit_entities", ecs::EidList)
            , ECS_RW_COMP(fill_hero_cockpit_entities_ecs_query_comps, "render_hero_cockpit_into_early_prepass", bool)
            );
...
static constexpr ecs::ComponentDesc gather_hero_cockpit_entities_ecs_query_comps[] =
{
//start of 4 ro components at [0]
...
static ecs::CompileTimeQueryDesc gather_hero_cockpit_entities_ecs_query_desc
(
  "gather_hero_cockpit_entities_ecs_query",
  empty_span(),
  make_span(gather_hero_cockpit_entities_ecs_query_comps+0, 4)/*ro*/,
  make_span(gather_hero_cockpit_entities_ecs_query_comps+4, 2)/*rq*/,
  empty_span());
template<typename Callable>
inline void gather_hero_cockpit_entities_ecs_query(Callable function)
{
  perform_query(g_entity_mgr, gather_hero_cockpit_entities_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
          function(
              ECS_RO_COMP(gather_hero_cockpit_entities_ecs_query_comps, "eid", ecs::EntityId)
            , ECS_RO_COMP_OR(gather_hero_cockpit_entities_ecs_query_comps, "isInVehicle", bool(false))
            , ECS_RO_COMP_OR(gather_hero_cockpit_entities_ecs_query_comps, "attaches_list", ecs::EidList(ecs::EidList{}))
            , ECS_RO_COMP_OR(gather_hero_cockpit_entities_ecs_query_comps, "human_weap__currentGunModEids", ecs::EidList(ecs::EidList{}))
            );
...
static constexpr ecs::component_t animchar_visbits_get_type(){return ecs::ComponentTypeInfo<unsigned char>::type; }
