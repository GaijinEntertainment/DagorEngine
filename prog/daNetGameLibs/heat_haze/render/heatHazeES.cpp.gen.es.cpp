...
//start of 5 rw components at [0]
  ...
  {ECS_HASH("heat_haze__render_clear_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
  {ECS_HASH("heat_haze__render_particles_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
  {ECS_HASH("heat_haze__apply_node"), ecs::ComponentTypeInfo<dabfg::NodeHandle>()},
...
static void init_heat_haze_es_event_handler_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    ...
    , ECS_RW_COMP(init_heat_haze_es_event_handler_comps, "heat_haze__render_clear_node", dabfg::NodeHandle)
    , ECS_RW_COMP(init_heat_haze_es_event_handler_comps, "heat_haze__render_particles_node", dabfg::NodeHandle)
    , ECS_RW_COMP(init_heat_haze_es_event_handler_comps, "heat_haze__apply_node", dabfg::NodeHandle)
...
static void heat_haze_render_features_changed_es_event_handler_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    ...
    , ECS_RW_COMP(heat_haze_render_features_changed_es_event_handler_comps, "heat_haze__render_clear_node", dabfg::NodeHandle)
    , ECS_RW_COMP(heat_haze_render_features_changed_es_event_handler_comps, "heat_haze__render_particles_node", dabfg::NodeHandle)
    , ECS_RW_COMP(heat_haze_render_features_changed_es_event_handler_comps, "heat_haze__apply_node", dabfg::NodeHandle)
