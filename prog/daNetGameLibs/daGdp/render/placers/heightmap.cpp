...
static ShaderVariableInfo density_mask("dagdp_heightmap__density_mask", true);
static ShaderVariableInfo density_mask_sampler("dagdp_heightmap__density_mask_samplerstate", true);
static ShaderVariableInfo density_mask_scale_offset("dagdp_heightmap__density_mask_scale_offset", true);
static ShaderVariableInfo density_mask_channel_weights("dagdp_heightmap__density_mask_channel_weights", true);
...
static ShaderVariableInfo grid_jitter("dagdp_heightmap__grid_jitter", true);
static ShaderVariableInfo displacement_noise_scale("dagdp_heightmap__displacement_noise_scale", true);
static ShaderVariableInfo displacement_strength("dagdp_heightmap__displacement_strength", true);
static ShaderVariableInfo placement_noise_scale("dagdp_heightmap__placement_noise_scale", true);
static ShaderVariableInfo sample_range("dagdp_heightmap__sample_range", true);
static ShaderVariableInfo lower_level("dagdp_heightmap__lower_level", true);
static ShaderVariableInfo use_decals("dagdp_heightmap__use_decals", true);
static ShaderVariableInfo discard_on_grass_erasure("dagdp_heightmap__discard_on_grass_erasure", true);
