...
inline void dagdp::heightmap_debug_imgui_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, heightmap_debug_imgui_ecs_query_desc.getHandle(),
