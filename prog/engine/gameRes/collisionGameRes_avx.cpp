...
bool CollisionResource::traceRayMeshNodeLocalCullCCW_AVX256(const Point3_vec4 *verticesBase, const uint32_t *indicesBase,
...
template <bool check_bounding, uint32_t mainBatchSize>
bool CollisionResource::rayHitMeshNodeLocalCullCCW_AVX256(const Point3_vec4 *verticesBase, const uint32_t *indicesBase,
...
template <bool check_bounding, uint32_t mainBatchSize>
bool CollisionResource::traceRayMeshNodeLocalAllHits_AVX256(const Point3_vec4 *verticesBase, const uint32_t *indicesBase,
