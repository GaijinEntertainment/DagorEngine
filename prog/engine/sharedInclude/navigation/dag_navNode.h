...
public:
  ...
  // betauser
  static CNavNode *GetNode(const Vector *pos, real tolerance); ///< return navigation node at the position, or NULL if none exists
...
private:
  ...
  unsigned char m_visited; ///< flags for automatic node generation. If direction bit is clear, that direction hasn't been explored
                           ///< yet.
