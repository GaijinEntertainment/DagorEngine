...
static ecs::LTComponentList hierarchy_eid_component(ECS_HASH("hierarchy_eid"), hierarchy_eid_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "attach_entity_to_hierarchy_es", 0);
static constexpr ecs::component_t hierarchy_last_parent_get_type();
static ecs::LTComponentList hierarchy_last_parent_component(ECS_HASH("hierarchy_last_parent"), hierarchy_last_parent_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "", 0);
static constexpr ecs::component_t hierarchy_parent_get_type();
static ecs::LTComponentList hierarchy_parent_component(ECS_HASH("hierarchy_parent"), hierarchy_parent_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "", 0);
static constexpr ecs::component_t hierarchy_transform_get_type();
static ecs::LTComponentList hierarchy_transform_component(ECS_HASH("hierarchy_transform"), hierarchy_transform_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "", 0);
static constexpr ecs::component_t hierarchy_transformation_get_type();
static ecs::LTComponentList hierarchy_transformation_component(ECS_HASH("hierarchy_transformation"), hierarchy_transformation_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "attach_entity_to_hierarchy_es", 0);
static constexpr ecs::component_t transform_get_type();
static ecs::LTComponentList transform_component(ECS_HASH("transform"), transform_get_type(), "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl", "perform_hierarchy_ecs_query", 0);
...
(
  ...
  "prog/engine/daECS/hierarchyTransform/hierarchyTransformES.cpp.inl",
...
(
  ...
  empty_span());
template<typename Callable>
inline void collect_to_resolve_hierarchy_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, collect_to_resolve_hierarchy_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void resolve_hierarchy_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, resolve_hierarchy_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void reresolve_hierarchy_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, reresolve_hierarchy_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
