...
public final class MessageBoxWrapper {
    ...
    public static int showAlert(final Activity activity, final String title, final String message, final String bt1Text,
            final String bt2Text, final String bt3Text) {
        Log.e(TAG, "ShowAlert");
