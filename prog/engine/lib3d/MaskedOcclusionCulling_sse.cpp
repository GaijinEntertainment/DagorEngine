...
#define MOC_STATIC_DOWNCAST(x)       static_cast<masked_occlusion_culling_sse2_or_41::MaskedOcclusionCullingPrivate *>(x)
#define MOC_STATIC_DOWNCAST_CONST(x) static_cast<const masked_occlusion_culling_sse2_or_41::MaskedOcclusionCullingPrivate *>(x)
...
MaskedOcclusionCulling::CullingResult MaskedOcclusionCulling::RenderBlasStackless(const unsigned char *blasData, int vertOffset,
  int treeStart, int treeEnd, const float *rawToClipMatrix, unsigned int *cacheIndices, uint32_t cacheIndicesCapacity,
...
MaskedOcclusionCulling::CullingResult MaskedOcclusionCulling::RenderBlasSOA4(const unsigned char *blasData, int vertOffset,
  const soa4::RootRef &root, const float *rawToClipMatrix, unsigned int *cacheIndices, uint32_t cacheIndicesCapacity,
  uint32_t &cacheTriCount, CacheMode cacheMode, BackfaceWinding bfWinding, ClipPlanes clipPlaneMask, uint32_t triSkip,
  uint32_t triLimit)
{
