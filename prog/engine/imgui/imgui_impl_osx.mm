...
{
    NSWindow* window = (NSWindow*)viewport->PlatformHandleRaw;
    window = nil;
...
bool ImGui_Multiview_Init()
{
  ...
  return ImGui_ImplOSX_Init(mainWnd.contentView);
}

void ImGui_Multiview_NewFrame()
{
  NSWindow *mainWnd = (NSWindow*)win32_get_main_wnd();
  ImGui_ImplOSX_NewFrame(mainWnd.contentView);
}
