...
VECTORCALL bool get_lines_intersection(Point2 start1, Point2 end1, Point2 start2, Point2 end2, Point2 *out_intersection = NULL)
{
...
VECTORCALL bool is_lines_intersect(const Point2 p11, const Point2 p12, const Point2 p21, const Point2 p22)
{
