...
DX12_HARDWARE_COMMAND(RESOLVE_SUBRESOURCE_REGION, "ResolveSubresourceRegion", ID3D12Resource *, UINT, ID3D12Resource *, UINT,
  DXGI_FORMAT, UINT)
...
DX12_HARDWARE_COMMAND(BARRIER, "Barrier", UINT /*, const D3D12_BARRIER_GROUP **/)
