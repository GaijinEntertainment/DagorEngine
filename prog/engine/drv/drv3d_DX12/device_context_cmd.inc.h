...
DX12_BEGIN_CONTEXT_COMMAND(DrawIndexed)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(SetVertexRootConstant)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(false)
...
DX12_BEGIN_CONTEXT_COMMAND_EXT_1(SetUniformBuffer, char, name)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(false)
...
DX12_BEGIN_CONTEXT_COMMAND(AsBarrier)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(false)
...
#if D3D_HAS_RAY_TRACING
DX12_BEGIN_CONTEXT_COMMAND(RaytraceCopyAccelerationStructure)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(FinishFrame)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
  DX12_CONTEXT_COMMAND_PARAM(uint64_t, progress)
...
DX12_BEGIN_CONTEXT_COMMAND(ExecuteDlssG)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(DispatchFSR)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(CommandFence)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(MoveBuffer)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(MoveTexture)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND_EXT_1(AddShaderGroup, char, name)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
...
DX12_BEGIN_CONTEXT_COMMAND(CompilePipelineSet2)
  DX12_CONTEXT_COMMAND_IS_PRIMARY(true)
  DX12_CONTEXT_COMMAND_PARAM(eastl::span<InputLayoutIDWithHash>, inputLayouts)
  DX12_CONTEXT_COMMAND_PARAM(eastl::span<StaticRenderStateIDWithHash>, staticRenderStates)
  DX12_CONTEXT_COMMAND_PARAM(eastl::span<FramebufferLayoutWithHash>, framebufferLayouts)
