jam -sRoot=../../.. -sPlatform=win32 -f drv3d_DX11/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_DX12/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_vulkan/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_null/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_stub/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_pc_multi/jamfile
jam -sRoot=../../.. -sPlatform=win32 -f drv3d_use_d3di/jamfile
...
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_DX11/jamfile
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_vulkan/jamfile
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_null/jamfile
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_stub/jamfile
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_pc_multi/jamfile
jam -sRoot=../../.. -sPlatform=win64 -f drv3d_use_d3di/jamfile
