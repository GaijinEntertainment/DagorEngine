...
#if OPENSSL_IS_STATICALLY_LINKED // https://manpages.debian.org/stretch/libssl-doc/OPENSSL_cleanup.3ssl.en.html
struct CleanupOnThreadExit
{
  ~CleanupOnThreadExit() { OPENSSL_thread_stop(); }
};
thread_local CleanupOnThreadExit cleanup_on_thread_exit;
#endif
} // namespace crypto
