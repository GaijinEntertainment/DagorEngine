...
static constexpr ecs::component_t slot_attach__attachedTo_get_type();
static ecs::LTComponentList slot_attach__attachedTo_component(ECS_HASH("slot_attach__attachedTo"), slot_attach__attachedTo_get_type(), "prog/daNetGame/net/netComponentFiltersES.cpp.inl", "", 0);
...
static constexpr ecs::component_t slot_attach__attachedTo_get_type(){return ecs::ComponentTypeInfo<ecs::EntityId>::type; }
