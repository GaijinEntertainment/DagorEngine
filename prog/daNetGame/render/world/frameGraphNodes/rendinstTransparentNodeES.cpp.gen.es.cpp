...
(
  ...
  0
,"render");
//static constexpr ecs::ComponentDesc create_transparent_triangle_debug_es_comps[] ={};
static void create_transparent_triangle_debug_es_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  G_UNUSED(components);
  G_FAST_ASSERT(evt.is<CreateTriangleDebugNodes>());
  create_transparent_triangle_debug_es(static_cast<const CreateTriangleDebugNodes&>(evt)
        );
}
static ecs::EntitySystemDesc create_transparent_triangle_debug_es_es_desc
(
  "create_transparent_triangle_debug_es",
  "prog/daNetGame/render/world/frameGraphNodes/rendinstTransparentNodeES.cpp.inl",
  ecs::EntitySystemOps(nullptr, create_transparent_triangle_debug_es_all_events),
  empty_span(),
  empty_span(),
  empty_span(),
  empty_span(),
