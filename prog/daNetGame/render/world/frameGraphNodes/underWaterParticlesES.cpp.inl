...
dafg::NodeHandle makeUnderWaterParticlesNode()
{
  return dafg::register_node("under_water_particles_node", DAFG_PP_NODE_SRC, [](dafg::Registry registry) {
    ...
    const char *depthTex = "depth_for_transparency";
...
static void create_under_water_particle_node_es(const OnCameraNodeConstruction &evt)
{
  evt.nodes->push_back(makeUnderWaterParticlesNode());
}
