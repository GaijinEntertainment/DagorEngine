...
{
inline void priority_shadervar_set_float(int id, int prio, float value) { PriorityShadervar::set_float(id, prio, value); }
inline void priority_shadervar_set_int(int id, int prio, int value) { PriorityShadervar::set_int(id, prio, value); }
inline void priority_shadervar_set_float4(int id, int prio, Point4 value) { PriorityShadervar::set_float4(id, prio, value); }
