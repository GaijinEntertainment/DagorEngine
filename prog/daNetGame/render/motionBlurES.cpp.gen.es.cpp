...
inline void query_motion_blur_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, query_motion_blur_ecs_query_desc.getHandle(),
...
(
  ...
  empty_span());
template<typename Callable>
inline void query_motion_blur_scale_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, query_motion_blur_scale_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void set_motion_blur_mode_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, set_motion_blur_mode_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
...
(
  ...
  empty_span());
template<typename Callable>
inline void delete_motion_blur_ecs_query(ecs::EntityManager &manager, Callable function)
{
  perform_query(&manager, delete_motion_blur_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        auto comp = components.begin(), compE = components.end(); G_ASSERT(comp != compE); do
        {
