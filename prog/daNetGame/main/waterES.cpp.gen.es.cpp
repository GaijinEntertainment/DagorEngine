...
//start of 1 rw components at [0]
  {ECS_HASH("water"), ecs::ComponentTypeInfo<FFTWater>()},
//start of 15 ro components at [1]
  ...
  {ECS_HASH("water__flowmap_foam_color_0"), ecs::ComponentTypeInfo<Point4>()},
  {ECS_HASH("water__flowmap_foam_color_1"), ecs::ComponentTypeInfo<Point4>()},
  {ECS_HASH("water__flowmap_foam_smoothness"), ecs::ComponentTypeInfo<float>()},
  {ECS_HASH("water__flowmap_foam_softness"), ecs::ComponentTypeInfo<float>()},
...
static void water_flowmap_foam_es_event_handler_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    ...
    , ECS_RO_COMP(water_flowmap_foam_es_event_handler_comps, "water__flowmap_foam_color_0", Point4)
    , ECS_RO_COMP(water_flowmap_foam_es_event_handler_comps, "water__flowmap_foam_color_1", Point4)
    , ECS_RO_COMP(water_flowmap_foam_es_event_handler_comps, "water__flowmap_foam_smoothness", float)
    , ECS_RO_COMP(water_flowmap_foam_es_event_handler_comps, "water__flowmap_foam_softness", float)
...
(
  ...
  make_span(water_flowmap_foam_es_event_handler_comps+1, 15)/*ro*/,
  empty_span(),
  empty_span(),
  ecs::EventSetBuilder<ecs::EventEntityCreated,
                       ecs::EventComponentsAppear>::build(),
  0
,nullptr,"water__flowmap_detail,water__flowmap_foam_color_0,water__flowmap_foam_color_1,water__flowmap_foam_depth_max,water__flowmap_foam_power,water__flowmap_foam_scale,water__flowmap_foam_smoothness,water__flowmap_foam_softness,water__flowmap_foam_speed_scale,water__flowmap_foam_threshold,water__flowmap_foam_tiling,water__flowmap_slope,water__flowmap_speed_depth_max,water__flowmap_speed_depth_scale,water__has_slopes");
static constexpr ecs::ComponentDesc water_flowmap_foam_2_es_event_handler_comps[] =
{
//start of 1 rw components at [0]
  {ECS_HASH("water"), ecs::ComponentTypeInfo<FFTWater>()},
//start of 1 ro components at [1]
  {ECS_HASH("water__flowmap_foam_bumpmapping_scale"), ecs::ComponentTypeInfo<float>()}
};
static void water_flowmap_foam_2_es_event_handler_all_events(const ecs::Event &__restrict evt, const ecs::QueryView &__restrict components)
{
  auto comp = components.begin(), compE = components.end(); G_ASSERT(comp!=compE); do
    water_flowmap_foam_2_es_event_handler(evt
        , ECS_RW_COMP(water_flowmap_foam_2_es_event_handler_comps, "water", FFTWater)
    , ECS_RO_COMP(water_flowmap_foam_2_es_event_handler_comps, "water__flowmap_foam_bumpmapping_scale", float)
    );
  while (++comp != compE);
}
static ecs::EntitySystemDesc water_flowmap_foam_2_es_event_handler_es_desc
(
  "water_flowmap_foam_2_es",
  "prog/daNetGame/main/waterES.cpp.inl",
  ecs::EntitySystemOps(nullptr, water_flowmap_foam_2_es_event_handler_all_events),
  make_span(water_flowmap_foam_2_es_event_handler_comps+0, 1)/*rw*/,
  make_span(water_flowmap_foam_2_es_event_handler_comps+1, 1)/*ro*/,
  empty_span(),
  empty_span(),
  ecs::EventSetBuilder<ecs::EventEntityCreated,
                       ecs::EventComponentsAppear>::build(),
  0
,nullptr,"water__flowmap_foam_bumpmapping_scale");
