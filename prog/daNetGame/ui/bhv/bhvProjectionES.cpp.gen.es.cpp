...
inline void visibility_ecs_query(ecs::EntityManager &manager, ecs::EntityId eid, Callable function)
{
  perform_query(&manager, eid, visibility_ecs_query_desc.getHandle(),
