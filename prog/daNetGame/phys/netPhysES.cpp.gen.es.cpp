...
{
//start of 1 rw components at [0]
  {ECS_HASH("phys_body"), ecs::ComponentTypeInfo<JoltPhysBody>(), ecs::CDF_OPTIONAL},
//start of 14 ro components at [1]
  ...
  {ECS_HASH("phys__inverseOmega"), ecs::ComponentTypeInfo<ecs::Tag>(), ecs::CDF_OPTIONAL},
...
(
  ...
  make_span(collision_obj_eid_ecs_query_comps+0, 1)/*rw*/,
  make_span(collision_obj_eid_ecs_query_comps+1, 14)/*ro*/,
  empty_span(),
  empty_span());
template<typename Callable>
inline bool collision_obj_eid_ecs_query(ecs::EntityManager &manager, ecs::EntityId eid, Callable function)
{
  return perform_query(&manager, eid, collision_obj_eid_ecs_query_desc.getHandle(),
    [&function](const ecs::QueryView& __restrict components)
    {
        constexpr size_t comp = 0;
        {
          function(
            ...
            , ECS_RO_COMP_PTR(collision_obj_eid_ecs_query_comps, "collres", CollisionResource)
            , ECS_RO_COMP_PTR(collision_obj_eid_ecs_query_comps, "phys__inverseOmega", ecs::Tag)
            , ECS_RW_COMP_PTR(collision_obj_eid_ecs_query_comps, "phys_body", JoltPhysBody)
