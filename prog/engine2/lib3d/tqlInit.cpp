...
static void init_ddsx_loader_and_genmip()
{
  ...
  {
    case _MAKE4C('DX11'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("directx")->getInt("max_genmip_tex_sz", 0); break;
    case _MAKE4C('DX12'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("dx12")->getInt("max_genmip_tex_sz", 4 * 1024); break;
    case _MAKE4C('VULK'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("vulkan")->getInt("max_genmip_tex_sz", 0); break;
    case _MAKE4C('MTL'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("video")->getInt("max_genmip_tex_sz", 4096); break;
    case _MAKE4C('PS4'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("ps4")->getInt("max_genmip_tex_sz", 0); break;
    case _MAKE4C('PS5'): max_genmip_sz = dgs_get_settings()->getBlockByNameEx("ps5")->getInt("max_genmip_tex_sz", 2048); break;
  }
