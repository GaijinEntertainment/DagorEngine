...
class FrontGraphicsState
  : public TrackedState<FrontGraphicsStateStorage, FrontRenderPassState, FrontFramebufferState, StateFieldGraphicsViewport,
      ...
      StateFieldGraphicsStencilRefOverride, StateFieldGraphicsVertexBuffers, StateFieldGraphicsIndexBuffer,
      StateFieldStageResourceBinds<STAGE_PS>, StateFieldStageResourceBinds<STAGE_VS>>
{
public:
  VULKAN_TRACKED_STATE_DEFAULT_NESTED_FIELD_CB();
};

class BackGraphicsState : public TrackedState<BackGraphicsStateStorage, StateFieldRenderPassResource, StateFieldGraphicsInPass,
                            StateFieldGraphicsViewport, StateFieldGraphicsPipelineLayout, StateFieldGraphicsBasePipeline,
                            StateFieldGraphicsFlush, StateFieldGraphicsRenderPassScopeOpener, StateFieldGraphicsFramebuffer,
                            StateFieldGraphicsRenderPassClass, StateFieldGraphicsConditionalRenderingScopeOpener,

                            StateFieldGraphicsPrimitiveTopology, StateFieldGraphicsDynamicRenderStateIndex, BackDynamicGraphicsState,
                            StateFieldGraphicsPipeline, StateFieldGraphicsDepthBounds, StateFieldGraphicsBlendConstantFactor,
                            StateFieldGraphicsIndexBuffer, StateFieldGraphicsVertexBuffersBindArray>
{
public:
  template <typename T>
  void reset(T &);
