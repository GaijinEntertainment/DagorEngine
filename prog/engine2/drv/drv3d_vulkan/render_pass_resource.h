...
struct RenderPassDescription
{
  ...
  Tab<Tab<ImageState>> attImageStates;
  uint64_t hash;
...
private:
  ...
  void updateImageState(ExecutionContext &ctx, uint32_t att_index, bool need_external_barrier, ImageState new_state);
  ...
  ImageState imageStateFromLayout(VkImageLayout layout);
