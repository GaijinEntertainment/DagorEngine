...
struct GraphicsPipelineStaticState
{
  union
  {
    struct
    {
      uint64_t conservativeRasterEnable : 1;
      uint64_t cullMode : 2;
      uint64_t depthTestEnable : 1;
      uint64_t depthWriteEnable : 1;
      uint64_t depthTestFunc : 3;
      uint64_t depthBoundsEnable : 1;
      uint64_t depthClipEnable : 1;
      uint64_t stencilTestEnable : 1;
      uint64_t stencilTestFunc : 3;
      uint64_t stencilTestOpStencilFail : 3;
      uint64_t stencilTestOpDepthFail : 3;
      uint64_t stencilTestOpPass : 3;
      uint64_t blendEnable : 1;
      uint64_t blendSeparateAlphaEnable : 1;
      uint64_t blendOp : 3;
      uint64_t blendOpAlpha : 3;
      uint64_t blendSrcFactor : 5;
      uint64_t blendDstFactor : 5;
      uint64_t blendSrcAlphaFactor : 5;
      uint64_t blendDstAlphaFactor : 5;
      // stores power of two of count plus one so that 0 is 0 not 1
      uint64_t forcedSampleCountExponent : 3;
  ...
  void reset()
  {
    ...
    blendEnable = 0;
    blendSeparateAlphaEnable = 0;
    blendOp = VK_BLEND_OP_ADD;
    blendOpAlpha = VK_BLEND_OP_ADD;
    blendSrcFactor = VK_BLEND_FACTOR_ONE;
    blendDstFactor = VK_BLEND_FACTOR_ZERO;
    blendSrcAlphaFactor = VK_BLEND_FACTOR_ONE;
    blendDstAlphaFactor = VK_BLEND_FACTOR_ZERO;
