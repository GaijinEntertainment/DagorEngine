...
void ShaderProgramDatabase::initDebugProg(DeviceContext &dc)
{
  ...
  ShaderID vs, fs;
  {
    ...
    auto from = reinterpret_cast<const uint32_t *>(debug_vert_program);
    auto to = reinterpret_cast<const uint32_t *>(debug_vert_program + sizeof(debug_vert_program));
