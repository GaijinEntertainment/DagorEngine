...
void BindlessManagerBackend::cleanupBindlessTexture(uint32_t index, Image *image)
{
  ...
  descriptorImageInfo.imageView = dummyResourceTable[spirv::MISSING_SAMPLED_IMAGE_2D_INDEX].image.imageView;
  descriptorImageInfo.imageLayout = dummyResourceTable[spirv::MISSING_SAMPLED_IMAGE_2D_INDEX].image.imageLayout;
