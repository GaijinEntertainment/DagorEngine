...
static constexpr ImageGlobalSubresouceId swapchain_color_texture_global_id = ImageGlobalSubresouceId::makec(0);
static constexpr ImageGlobalSubresouceId swapchain_secondary_color_texture_global_id = ImageGlobalSubresouceId::makec(1);
static constexpr ImageGlobalSubresouceId first_dynamic_texture_global_id = ImageGlobalSubresouceId::makec(2);
