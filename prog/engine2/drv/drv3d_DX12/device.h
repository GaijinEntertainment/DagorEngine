...
public:
  ...
  bool init(DXGIFactory *factory, AdapterInfo &&adapterInfo, D3D_FEATURE_LEVEL feature_level, const Direct3D12Enviroment &d3d_env,
    SwapchainCreateInfo swapchain_create_info, debug::GlobalState &debug_state, ShaderProgramDatabase &spd, const Config &cfg,
  ...
  bool getGpuMemUsageStats(uint32_t *out_mem_size, uint32_t *out_free_mem_kb, uint32_t *out_used_mem_kb);
#if D3D_HAS_RAY_TRACING
