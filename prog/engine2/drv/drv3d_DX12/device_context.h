...
struct GraphicsState
{
  ...
  InternalInputLayoutID inputLayoutIdent = InternalInputLayoutID::Null();
...
struct FrameInfo
{
  ...
  eastl::vector<eastl::unique_ptr<VertexShaderModule>> deletedVertexShaderModules;
  eastl::vector<eastl::unique_ptr<PixelShaderModule>> deletedPixelShaderModules;
...
#undef DX12_CONTEXT_COMMAND_PARAM_ARRAY
  ...
  public:
    ...
    void setInputLayout(InternalInputLayoutID ident);
...
public:
  ...
  void bindVertexDecl(InternalInputLayoutID ident);
