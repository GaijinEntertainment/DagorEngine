  ...
  renderingAPI(rendering_api), oxrSessionState(XR_SESSION_STATE_UNKNOWN)
{
  ...
  if (renderingAPI == RenderingAPI::Default)
  {
    ...
    {
      case _MAKE4C('DX11'): renderingAPI = RenderingAPI::D3D11; break;
      case _MAKE4C('DX12'): renderingAPI = RenderingAPI::D3D12; break;
      case _MAKE4C('VULK'): renderingAPI = RenderingAPI::Vulkan; break;
    }
#elif _TARGET_ANDROID
