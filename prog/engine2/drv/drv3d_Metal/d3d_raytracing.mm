...
{
  G_UNUSED(flags);
  return drv3d_metal::render.createBottomAccelerationStructure();
}
  ...
  uint32_t count, RaytraceBuildFlags flags, bool update)
{
  G_UNUSED(flags);
  G_UNUSED(update);
  drv3d_metal::render.scheduleBLASBuild(as, desc);
}
...
RaytraceTopAccelerationStructure *d3d::create_raytrace_top_acceleration_structure(uint32_t elements, RaytraceBuildFlags flags)
{
  G_UNUSED(flags);
  G_UNUSED(elements);
  return drv3d_metal::render.createTopAccelerationStructure();
}

void d3d::build_top_acceleration_structure(RaytraceTopAccelerationStructure *as, Sbuffer *instanceDescriptorBuffer, uint32_t instanceCount,
  RaytraceBuildFlags flags, bool update)
{
  G_UNUSED(flags);
  G_UNUSED(update);
  drv3d_metal::render.scheduleTLASBuild(as, instanceDescriptorBuffer, instanceCount);
}
