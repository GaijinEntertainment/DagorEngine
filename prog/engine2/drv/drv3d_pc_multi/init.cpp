...
static const carray<unsigned, API_COUNT> api_drv_codes = {
  _MAKE4C('DX11'), // API_DX11
  _MAKE4C('STUB'), // API_STUB
  _MAKE4C('VULK'), // API_VULKAN
  _MAKE4C('MTL'),  // API_METAL
  _MAKE4C('DX12'), // API_DX12
};
...
unsigned d3d::get_driver_code()
{
  ...
  return api >= 0 && api < API_COUNT ? api_drv_codes[api] : API_NONE; //-V560
}
