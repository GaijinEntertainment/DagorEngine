...
namespace ShUtils
{
const char *fsh_version(int fshVersion)
{
  const char *ver = NULL;
  switch (fshVersion)
  {
    case FSHVER_FFP: ver = "ffp"; break;
    case FSHVER_NV20: ver = "1.1"; break;
    case FSHVER_NV25: ver = "1.3"; break;
    case FSHVER_R200: ver = "1.4"; break;
    case FSHVER_R300: ver = "2.0"; break;
    case FSHVER_20B: ver = "2.B"; break;
    case FSHVER_20A: ver = "2.A"; break;
    case FSHVER_30: ver = "3.0"; break;
    case FSHVER_40: ver = "4.0"; break;
    case FSHVER_41: ver = "4.1"; break;
    case FSHVER_50: ver = "5.0"; break;
    case FSHVER_60: ver = "6.0"; break;
    case FSHVER_66: ver = "6.6"; break;
  }
  G_ASSERT(ver);
  return ver;
}
