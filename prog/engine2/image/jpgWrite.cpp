...
typedef struct
{
  ...
  IGenSave *cwr;  /* target stream */
  JOCTET *buffer; /* start of buffer */
} dagor_jpeg_destination_mgr;

typedef dagor_jpeg_destination_mgr *dagor_jpeg_dest_ptr;
...
{
  dagor_jpeg_dest_ptr dest = (dagor_jpeg_dest_ptr)cinfo->dest;
...
GLOBAL(void) jpeg_stream_dest(j_compress_ptr cinfo, IGenSave &outfile)
{
  dagor_jpeg_dest_ptr dest;
  ...
  { /* first time for this JPEG object? */
    cinfo->dest = (struct jpeg_destination_mgr *)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT,
      SIZEOF(dagor_jpeg_destination_mgr));
  }

  dest = (dagor_jpeg_dest_ptr)cinfo->dest;
