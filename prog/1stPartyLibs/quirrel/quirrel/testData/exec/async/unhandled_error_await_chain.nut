...
// already unwound (empty CALLSTACK), so the surviving record is the Error's
// trace: the throw-site origin frame followed by an `awaited at` frame per folded
// async ancestor, inner-to-outer.
