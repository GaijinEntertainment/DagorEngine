#include "testMapSerialization.pb.h"
...
{
  stream.blockBegin(saveOptions.getNumber());
  proto::io::writeMapVersioned(stream, 1, items, &TestItem::saveToDB);
    ...
    proto::io::StreamTag tag)
{
  ...
  while (true)
  {
    ...
    {
      case 1:
        PROTO_VALIDATE((proto::io::MapSerialization<TStringToTestItemUnorderedMap, true>::readMap(
