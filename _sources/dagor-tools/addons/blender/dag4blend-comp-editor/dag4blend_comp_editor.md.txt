...
![How to Enable](_images/dag4blend_comp_ed_01.jpg)

![How to Enable](_images/dag4blend_comp_ed_02.jpg)
...
![CMP Import](_images/dag4blend_comp_ed_03.jpg)
...
- **with lods**: Available only when the previous checkbox is active. This
  option allows you to import not just `lod00` but all other LODs as well. Keep
  in mind that this significantly slows down the import process and increases
  the scene’s complexity – useful only when you need to adjust a mesh in a small
  composite, rather than the position of nodes. For example, if you need to
  reposition a couple of apples so they don’t stick out of a box in a composite,
  and the apple pile is a single mesh, you still need to update all LODs, not
  just the first one.
...
![CMP Import](_images/dag4blend_comp_ed_04.jpg)
...
![CMP Import](_images/dag4blend_comp_ed_05.jpg)
...
1. **Adding an Empty Object**:
   ...
   **Entities** panel, and select the desired object’s collection from the
   ...
   ![Adding an Empty Object](_images/dag4blend_comp_ed_06.jpg)
...
2. **Dragging a Collection**:
   ...
   ![Dragging a Collection](_images/dag4blend_comp_ed_07.jpg)

   ![Dragging a Collection](_images/dag4blend_comp_ed_08.jpg)
...
3. **Enabling Instancing via Object Properties**:
   ...
   ![Enabling Instancing via Object Properties](_images/dag4blend_comp_ed_09.jpg)
...
![Editing Nodes](_images/dag4blend_comp_ed_10.jpg)
...
![Setting Node Types](_images/dag4blend_comp_ed_11.jpg)
...
![Setting Node Types](_images/dag4blend_comp_ed_12.jpg)
...
![Node Hierarchy](_images/dag4blend_comp_ed_13.jpg)
...
![Replacing Node Content](_images/dag4blend_comp_ed_14.jpg)

![Replacing Node Content](_images/dag4blend_comp_ed_15.jpg)
...
![BBOX to Node](_images/dag4blend_comp_ed_16.jpg)
...
![BBOX to Node](_images/dag4blend_comp_ed_17.jpg)

![BBOX to Node](_images/dag4blend_comp_ed_18.jpg)

![BBOX to Node](_images/dag4blend_comp_ed_19.jpg)
...
![To Mesh](_images/dag4blend_comp_ed_20.jpg)
...
![Explode](_images/dag4blend_comp_ed_21.jpg)

![Explode](_images/dag4blend_comp_ed_22.jpg)
...
![Explode](_images/dag4blend_comp_ed_23.jpg)
...
![Explode](_images/dag4blend_comp_ed_24.jpg)
...
![CMP Export](_images/dag4blend_comp_ed_25.jpg)
...
![CMP Export](_images/dag4blend_comp_ed_26.jpg)
